...
#define BSEC_SAMPLE_RATE_TPH          (0.066667f)            /*!< Sample rate in case of Low Power Mode */
#define BSEC_SAMPLE_RATE_CONTINUES          (1.0f)            /*!< Sample rate in case of Low Power Mode */
#define BSEC_SAMPLE_RATE_G          (0.016667f)            /*!< Sample rate in case of Low Power Mode */
