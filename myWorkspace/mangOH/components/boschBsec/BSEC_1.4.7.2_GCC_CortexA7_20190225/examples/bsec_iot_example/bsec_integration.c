 ...
 */
static bsec_library_return_t bme680_bsec_update_subscription(float sample_rate_IAQ,float sample_rate_TPH)
{
    ...
    requested_virtual_sensors[0].sample_rate = sample_rate_IAQ;
    requested_virtual_sensors[1].sensor_id = BSEC_OUTPUT_SENSOR_HEAT_COMPENSATED_TEMPERATURE;
    requested_virtual_sensors[1].sample_rate = sample_rate_TPH;
    requested_virtual_sensors[2].sensor_id = BSEC_OUTPUT_RAW_PRESSURE;
    requested_virtual_sensors[2].sample_rate = sample_rate_TPH;
    requested_virtual_sensors[3].sensor_id = BSEC_OUTPUT_SENSOR_HEAT_COMPENSATED_HUMIDITY;
    requested_virtual_sensors[3].sample_rate = sample_rate_TPH;
    requested_virtual_sensors[4].sensor_id = BSEC_OUTPUT_RAW_GAS;
    requested_virtual_sensors[4].sample_rate = sample_rate_IAQ;
    requested_virtual_sensors[5].sensor_id = BSEC_OUTPUT_RAW_TEMPERATURE;
    requested_virtual_sensors[5].sample_rate = sample_rate_TPH;
    requested_virtual_sensors[6].sensor_id = BSEC_OUTPUT_RAW_HUMIDITY;
    requested_virtual_sensors[6].sample_rate = sample_rate_TPH;
 ...
 */
return_values_init bsec_iot_init(float sample_rate_IAQ, float sample_rate_TPH, float temperature_offset, bme680_com_fptr_t bus_write, 
                    bme680_com_fptr_t bus_read, sleep_fct sleep, state_load_fct state_load, config_load_fct config_load)
{
    ...
    ret.bsec_status = bme680_bsec_update_subscription(sample_rate_IAQ,sample_rate_TPH);
    if (ret.bsec_status != BSEC_OK)
    {
        return ret;
    }
