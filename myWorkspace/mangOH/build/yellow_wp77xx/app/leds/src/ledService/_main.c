...
// Startup code for the executable 'ledService'.
...
LE_SHARED const char* _outputActuator_dhub_ServiceInstanceName = "ledService.outputActuator.dhub";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t ledService_exe_LogSession;
LE_SHARED le_log_Level_t* ledService_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    ledService_exe_LogSession = le_log_RegComponent("ledService_exe", &ledService_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_outputActuator.so");
    LoadLib("libComponent_leds.so");
