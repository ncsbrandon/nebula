...
// Startup code for the executable 'imu'.
...
LE_SHARED const char* _periodicSensor_dhubIO_ServiceInstanceName = "imu.periodicSensor.dhubIO";
LE_SHARED const char* _imu_imu_ServiceInstanceName = "imu";
LE_SHARED const char* _imu_temperature_ServiceInstanceName = "temperature";
LE_SHARED const char* _imu_dhubIO_ServiceInstanceName = "imu.imu.dhubIO";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t imu_exe_LogSession;
LE_SHARED le_log_Level_t* imu_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    imu_exe_LogSession = le_log_RegComponent("imu_exe", &imu_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_fileUtils.so");
    LoadLib("libComponent_periodicSensor.so");
    LoadLib("libComponent_imu.so");
