...
LE_SHARED const char* _fwupdateDaemon_le_pm_ServiceInstanceName = "fwupdateDaemon.fwupdateDaemon.le_pm";
...
int main(int argc, const char* argv[])
{
    ...
    fwupdateDaemon_exe_LogSession = le_log_RegComponent("fwupdateDaemon_exe", &fwupdateDaemon_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_le_pa_fwupdate_singlesys.so");
