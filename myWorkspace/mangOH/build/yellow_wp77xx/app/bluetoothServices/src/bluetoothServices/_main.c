...
// Startup code for the executable 'bluetoothServices'.
...
LE_SHARED const char* _bluetoothServicesComponent_dhubAdmin_ServiceInstanceName = "bluetoothServices.bluetoothServicesComponent.dhubAdmin";
LE_SHARED const char* _bluetoothServicesComponent_le_info_ServiceInstanceName = "bluetoothServices.bluetoothServicesComponent.le_info";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t bluetoothServices_exe_LogSession;
LE_SHARED le_log_Level_t* bluetoothServices_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    bluetoothServices_exe_LogSession = le_log_RegComponent("bluetoothServices_exe", &bluetoothServices_exe_LogLevelFilterPtr);
    ...
    LoadLib("libBluezDBus.so");
    LoadLib("libComponent_bluetoothServicesComponent.so");
