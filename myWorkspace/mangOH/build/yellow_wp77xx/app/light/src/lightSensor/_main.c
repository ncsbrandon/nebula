...
// Startup code for the executable 'lightSensor'.
...
LE_SHARED const char* _light_light_ServiceInstanceName = "light";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t lightSensor_exe_LogSession;
LE_SHARED le_log_Level_t* lightSensor_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    lightSensor_exe_LogSession = le_log_RegComponent("lightSensor_exe", &lightSensor_exe_LogLevelFilterPtr);
