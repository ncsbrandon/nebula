...
LE_SHARED const char* _modemDaemon_le_appInfo_ServiceInstanceName = "modemDaemon.modemDaemon.le_appInfo";
...
int main(int argc, const char* argv[])
{
    ...
    modemDaemon_exe_LogSession = le_log_RegComponent("modemDaemon_exe", &modemDaemon_exe_LogLevelFilterPtr);
