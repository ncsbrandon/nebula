...
// Startup code for the executable 'button'.
...
LE_SHARED const char* _button_dhubIO_ServiceInstanceName = "dhubIO";
LE_SHARED const char* _button_gpio_ServiceInstanceName = "gpio";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t button_exe_LogSession;
LE_SHARED le_log_Level_t* button_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    button_exe_LogSession = le_log_RegComponent("button_exe", &button_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_button.so");
