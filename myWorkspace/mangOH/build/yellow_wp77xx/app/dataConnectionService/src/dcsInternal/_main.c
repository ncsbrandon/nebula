...
// Startup code for the executable 'dcsInternal'.
...
LE_SHARED const char* _watchdogChain_le_wdog_ServiceInstanceName = "dcsInternal.watchdogChain.le_wdog";
LE_SHARED const char* _dcsInternal_le_dcs_ServiceInstanceName = "dcsInternal.dcsInternal.le_dcs";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t dcsInternal_exe_LogSession;
LE_SHARED le_log_Level_t* dcsInternal_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    dcsInternal_exe_LogSession = le_log_RegComponent("dcsInternal_exe", &dcsInternal_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_dcsInternal.so");
