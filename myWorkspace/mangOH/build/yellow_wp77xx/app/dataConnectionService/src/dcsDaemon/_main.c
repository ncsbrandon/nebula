...
LE_SHARED const char* _dcsNet_le_appInfo_ServiceInstanceName = "dcsDaemon.dcsNet.le_appInfo";
...
LE_SHARED const char* _dcsEthernet_le_cfg_ServiceInstanceName = "dcsDaemon.dcsEthernet.le_cfg";
...
int main(int argc, const char* argv[])
{
    ...
    dcsDaemon_exe_LogSession = le_log_RegComponent("dcsDaemon_exe", &dcsDaemon_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_le_pa_ethernet.so");
    LoadLib("libComponent_dcsEthernet.so");
