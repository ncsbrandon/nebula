...
// Startup code for the executable 'hubd'.
...
LE_SHARED const char* _dataHub_io_ServiceInstanceName = "io";
LE_SHARED const char* _dataHub_admin_ServiceInstanceName = "admin";
LE_SHARED const char* _dataHub_query_ServiceInstanceName = "query";
LE_SHARED const char* _dataHub_le_appInfo_ServiceInstanceName = "le_appInfo";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t hubd_exe_LogSession;
LE_SHARED le_log_Level_t* hubd_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    hubd_exe_LogSession = le_log_RegComponent("hubd_exe", &hubd_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_json.so");
    LoadLib("libComponent_dataHub.so");
