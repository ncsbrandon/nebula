...
// Startup code for the executable 'dhub'.
...
LE_SHARED const char* _adminTool_admin_ServiceInstanceName = "dhubToolAdmin";
LE_SHARED const char* _adminTool_query_ServiceInstanceName = "dhubToolQuery";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t dhub_exe_LogSession;
LE_SHARED le_log_Level_t* dhub_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    dhub_exe_LogSession = le_log_RegComponent("dhub_exe", &dhub_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_adminTool.so");
