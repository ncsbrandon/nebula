...
// Startup code for the executable 'buzzer'.
...
LE_SHARED const char* _buzzerComponent_dhubIO_ServiceInstanceName = "buzzer.buzzerComponent.dhubIO";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t buzzer_exe_LogSession;
LE_SHARED le_log_Level_t* buzzer_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    buzzer_exe_LogSession = le_log_RegComponent("buzzer_exe", &buzzer_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_buzzerComponent.so");
