...
// Startup code for the executable 'instaGrat'.
...
LE_SHARED const char* _yellowInstantGratification_dhubAdmin_ServiceInstanceName = "instaGrat.yellowInstantGratification.dhubAdmin";
LE_SHARED const char* _yellowInstantGratification_le_cfg_ServiceInstanceName = "instaGrat.yellowInstantGratification.le_cfg";
LE_SHARED const char* _yellowInstantGratification_le_pm_ServiceInstanceName = "instaGrat.yellowInstantGratification.le_pm";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t instaGrat_exe_LogSession;
LE_SHARED le_log_Level_t* instaGrat_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    instaGrat_exe_LogSession = le_log_RegComponent("instaGrat_exe", &instaGrat_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_yellowInstantGratification.so");
