...
LE_SHARED const char* _yellowCommandLine_dhubAdmin_ServiceInstanceName = "hello.yellowCommandLine.dhubAdmin";
LE_SHARED const char* _yellowCommandLine_le_info_ServiceInstanceName = "hello.yellowCommandLine.le_info";
LE_SHARED const char* _yellowCommandLine_le_sim_ServiceInstanceName = "hello.yellowCommandLine.le_sim";
LE_SHARED const char* _yellowCommandLine_le_cfg_ServiceInstanceName = "hello.yellowCommandLine.le_cfg";
...
int main(int argc, const char* argv[])
{
    ...
    hello_exe_LogSession = le_log_RegComponent("hello_exe", &hello_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_yellowCommandLine.so");
