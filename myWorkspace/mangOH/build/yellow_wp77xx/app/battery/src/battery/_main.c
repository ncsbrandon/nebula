...
// Startup code for the executable 'battery'.
...
LE_SHARED const char* _periodicSensor_dhubIO_ServiceInstanceName = "dhubIO";
LE_SHARED const char* _batteryComponentYellow_ma_battery_ServiceInstanceName = "ma_battery";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t battery_exe_LogSession;
LE_SHARED le_log_Level_t* battery_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    battery_exe_LogSession = le_log_RegComponent("battery_exe", &battery_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_batteryUtils.so");
    LoadLib("libComponent_periodicSensor.so");
    LoadLib("libComponent_batteryComponentYellow.so");
