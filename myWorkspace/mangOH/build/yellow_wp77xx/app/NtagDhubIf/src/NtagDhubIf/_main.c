...
LE_SHARED const char* _NtagDhubIfComponent_fieldDetectGpio_ServiceInstanceName = "NtagDhubIf.NtagDhubIfComponent.fieldDetectGpio";
LE_SHARED const char* _NtagDhubIfComponent_dhubIO_ServiceInstanceName = "dhubIO";
...
int main(int argc, const char* argv[])
{
    ...
    NtagDhubIf_exe_LogSession = le_log_RegComponent("NtagDhubIf_exe", &NtagDhubIf_exe_LogLevelFilterPtr);
