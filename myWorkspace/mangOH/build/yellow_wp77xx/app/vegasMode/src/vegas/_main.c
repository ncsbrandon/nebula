...
// Startup code for the executable 'vegas'.
...
LE_SHARED const char* _vegasMode_dhubIO_ServiceInstanceName = "dhubIO";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t vegas_exe_LogSession;
LE_SHARED le_log_Level_t* vegas_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    vegas_exe_LogSession = le_log_RegComponent("vegas_exe", &vegas_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_vegasMode.so");
