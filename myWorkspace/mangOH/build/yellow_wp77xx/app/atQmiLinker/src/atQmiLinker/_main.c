...
LE_SHARED const char* _atQmiLinker_le_port_ServiceInstanceName = "atQmiLinker.atQmiLinker.le_port";
...
int main(int argc, const char* argv[])
{
    ...
    atQmiLinker_exe_LogSession = le_log_RegComponent("atQmiLinker_exe", &atQmiLinker_exe_LogLevelFilterPtr);
