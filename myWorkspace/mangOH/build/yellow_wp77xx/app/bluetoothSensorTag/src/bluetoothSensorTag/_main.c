...
// Startup code for the executable 'bluetoothSensorTag'.
...
LE_SHARED const char* _sensorTagComponent_io_ServiceInstanceName = "bluetoothSensorTag.sensorTagComponent.io";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t bluetoothSensorTag_exe_LogSession;
LE_SHARED le_log_Level_t* bluetoothSensorTag_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    bluetoothSensorTag_exe_LogSession = le_log_RegComponent("bluetoothSensorTag_exe", &bluetoothSensorTag_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_sensorTagComponent.so");
