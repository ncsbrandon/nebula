...
LE_SHARED const char* _le_pa_secStoreTz_le_cfg_ServiceInstanceName = "secStore.le_pa_secStoreTz.le_cfg";
...
LE_SHARED const char* _secStoreDaemon_le_instStat_ServiceInstanceName = "secStore.secStoreDaemon.le_instStat";
...
int main(int argc, const char* argv[])
{
    ...
    secStore_exe_LogSession = le_log_RegComponent("secStore_exe", &secStore_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_le_pa_tz.so");
    LoadLib("libComponent_le_pa_secStoreTz.so");
