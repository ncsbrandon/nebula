...
// Startup code for the executable 'bme680EnvSensor'.
...
LE_SHARED const char* _bsecIntegrationComponent_mangOH_bme680_ServiceInstanceName = "mangOH_bme680";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t bme680EnvSensor_exe_LogSession;
LE_SHARED le_log_Level_t* bme680EnvSensor_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    bme680EnvSensor_exe_LogSession = le_log_RegComponent("bme680EnvSensor_exe", &bme680EnvSensor_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_boschBme680Driver.so");
    LoadLib("libComponent_bsecIntegrationComponent.so");
