...
// Startup code for the executable 'dataHubConnector'.
...
LE_SHARED const char* _bsec_io_ServiceInstanceName = "dhubIO";
LE_SHARED const char* _bsec_mangOH_bme680_ServiceInstanceName = "dataHubConnector.bsec.mangOH_bme680";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t dataHubConnector_exe_LogSession;
LE_SHARED le_log_Level_t* dataHubConnector_exe_LogLevelFilterPtr;
...
int main(int argc, const char* argv[])
{
    ...
    dataHubConnector_exe_LogSession = le_log_RegComponent("dataHubConnector_exe", &dataHubConnector_exe_LogLevelFilterPtr);
