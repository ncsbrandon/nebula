...
extern const char* _cm_le_mdmCfg_ServiceInstanceName;
const char** le_mdmCfg_ServiceInstanceNamePtr = &_cm_le_mdmCfg_ServiceInstanceName;
void le_mdmCfg_ConnectService(void);
...
__attribute__((constructor)) void _cm_Init(void)
{
    ...
    le_mdmCfg_ConnectService();
    le_cellnet_ConnectService();

    // Register the component with the Log Daemon.
    cm_LogSession = le_log_RegComponent("cm", &cm_LogLevelFilterPtr);
