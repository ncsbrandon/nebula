...
extern const char* _modemDaemon_le_appInfo_ServiceInstanceName;
const char** le_appInfo_ServiceInstanceNamePtr = &_modemDaemon_le_appInfo_ServiceInstanceName;
...
__attribute__((constructor)) void _modemDaemon_Init(void)
{
    ...
    modemDaemon_LogSession = le_log_RegComponent("modemDaemon", &modemDaemon_LogLevelFilterPtr);
