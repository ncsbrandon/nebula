...
static void Handle_imu_ReadAccel
(
...
static void Handle_imu_ReadGyro
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_imu_ReadAccel :
            Handle_imu_ReadAccel(msgRef);
            break;
        case _MSGID_imu_ReadGyro :
            Handle_imu_ReadGyro(msgRef);
            break;
