 ...
 * its expiration.
 *
 * Moreover, when IVS NAD is in <b>eCall only</b> mode, and the eCall has been normally ended by
 * PSAP or by le_ecall_End(), then the user can terminate registration state before T9/T10 or
 * NAD_DEREGISTRATION_TIME expired by le_ecall_TerminateRegistration().
 *
