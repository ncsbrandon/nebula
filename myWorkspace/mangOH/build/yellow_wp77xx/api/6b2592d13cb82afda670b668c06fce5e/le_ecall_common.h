 ...
 * ====================== WARNING ======================
 */
#ifndef LE_ECALL_COMMON_H_INCLUDE_GUARD
#define LE_ECALL_COMMON_H_INCLUDE_GUARD
...
#define IFGEN_LE_ECALL_PROTOCOL_ID "0a7ab48c487238261df0a2f2bfaa2e6b"
#define IFGEN_LE_ECALL_MSG_SIZE 156
...
typedef enum
{
    ...
    LE_ECALL_STATE_STOPPED = 13,
        ///< Auto answer timer has expired after eCall session
 ...
 */
//--------------------------------------------------------------------------------------------------/// Gasoline propulsion)
#define LE_ECALL_PROPULSION_TYPE_GASOLINE 0x1/// Diesel propulsion
#define LE_ECALL_PROPULSION_TYPE_DIESEL 0x2/// Compressed natural gas propulsion
#define LE_ECALL_PROPULSION_TYPE_NATURALGAS 0x4/// Liquid propane gas propulsion
#define LE_ECALL_PROPULSION_TYPE_PROPANE 0x8/// Electric propulsion
#define LE_ECALL_PROPULSION_TYPE_ELECTRIC 0x10/// Hydrogen propulsion
#define LE_ECALL_PROPULSION_TYPE_HYDROGEN 0x20/// Other type of propulsions
...
#define LE_ECALL_DIAG_RESULT_PRESENT_MIC_CONNECTION_FAILURE 0x1/// Mic connection failure status.
#define LE_ECALL_DIAG_RESULT_MIC_CONNECTION_FAILURE 0x2/// Present Mic  failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_MIC_FAILURE 0x4/// Mic failure status.
#define LE_ECALL_DIAG_RESULT_MIC_FAILURE 0x8/// Present Right speaker failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_RIGHT_SPEAKER_FAILURE 0x10/// Right speaker failure status.
#define LE_ECALL_DIAG_RESULT_RIGHT_SPEAKER_FAILURE 0x20/// Present Left speaker failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_LEFT_SPEAKER_FAILURE 0x40/// Left speaker failure status.
#define LE_ECALL_DIAG_RESULT_LEFT_SPEAKER_FAILURE 0x80/// Present Speaker failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_SPEAKERS_FAILURE 0x100/// Speaker failure status.
#define LE_ECALL_DIAG_RESULT_SPEAKERS_FAILURE 0x200/// Present Ignition line failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_IGNITION_LINE_FAILURE 0x400/// Ignition line failure status.
#define LE_ECALL_DIAG_RESULT_IGNITION_LINE_FAILURE 0x800/// Present UIM failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_UIM_FAILURE 0x1000/// UIM failure status.
#define LE_ECALL_DIAG_RESULT_UIM_FAILURE 0x2000/// Present Status indicator failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_STATUS_INDICATOR_FAILURE 0x4000/// Status indicator failure status.
#define LE_ECALL_DIAG_RESULT_STATUS_INDICATOR_FAILURE 0x8000/// Present Battery failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_BATTERY_FAILURE 0x10000/// Battery failure status.
#define LE_ECALL_DIAG_RESULT_BATTERY_FAILURE 0x20000/// Present Battery voltage low failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_BATTERY_VOLTAGE_LOW 0x40000/// Battery voltage low failure status.
#define LE_ECALL_DIAG_RESULT_BATTERY_VOLTAGE_LOW 0x80000/// Present Crash sensor failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_CRASH_SENSOR_FAILURE 0x100000/// Crash sensor failure status.
#define LE_ECALL_DIAG_RESULT_CRASH_SENSOR_FAILURE 0x200000/// Present Firmware image corruption failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_FIRMWARE_IMAGE_CORRUPTION 0x400000/// Firmware image corruption failure status.
#define LE_ECALL_DIAG_RESULT_FIRMWARE_IMAGE_CORRUPTION 0x800000/// Present Comm module interface failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_COMM_MODULE_INTERFACE_FAILURE 0x1000000/// Comm module interface failure status.
#define LE_ECALL_DIAG_RESULT_COMM_MODULE_INTERFACE_FAILURE 0x2000000/// Present GNSS receiver failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_GNSS_RECEIVER_FAILURE 0x4000000/// GNSS receiver failure status.
#define LE_ECALL_DIAG_RESULT_GNSS_RECEIVER_FAILURE 0x8000000/// Present RAIM problem.
#define LE_ECALL_DIAG_RESULT_PRESENT_RAIM_PROBLEM 0x10000000/// RAIM problem status.
#define LE_ECALL_DIAG_RESULT_RAIM_PROBLEM 0x20000000/// Present GNSS antenna failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_GNSS_ANTENNA_FAILURE 0x40000000/// GNSS antenna failure status.
#define LE_ECALL_DIAG_RESULT_GNSS_ANTENNA_FAILURE 0x80000000/// Present Comm module failure.
#define LE_ECALL_DIAG_RESULT_PRESENT_COMM_MODULE_FAILURE 0x100000000/// Comm module failure status.
#define LE_ECALL_DIAG_RESULT_COMM_MODULE_FAILURE 0x200000000/// Present Events memory overflow.
#define LE_ECALL_DIAG_RESULT_PRESENT_EVENTS_MEMORY_OVERFLOW 0x400000000/// Events memory overflow status.
#define LE_ECALL_DIAG_RESULT_EVENTS_MEMORY_OVERFLOW 0x800000000/// Present Crash profile memory overflow.
#define LE_ECALL_DIAG_RESULT_PRESENT_CRASH_PROFILE_MEMORY_OVERFLOW 0x1000000000/// Crash profile memory overflow status.
#define LE_ECALL_DIAG_RESULT_CRASH_PROFILE_MEMORY_OVERFLOW 0x2000000000/// Present Other critical failures.
#define LE_ECALL_DIAG_RESULT_PRESENT_OTHER_CRITICAL_FAILURES 0x4000000000/// Other critical failures status.
#define LE_ECALL_DIAG_RESULT_OTHER_CRITICAL_FAILURES 0x8000000000/// Present Other not critical failures.
#define LE_ECALL_DIAG_RESULT_PRESENT_OTHER_NOT_CRITICAL_FAILURES 0x10000000000/// Other not critical failures status.
...
#define LE_ECALL_CRASH_INFO_PRESENT_CRASH_FRONT 0x1/// Front collision indicator.
#define LE_ECALL_CRASH_INFO_CRASH_FRONT 0x2/// Present Left collision indicator.
#define LE_ECALL_CRASH_INFO_PRESENT_CRASH_LEFT 0x4/// Left collision indicator.
#define LE_ECALL_CRASH_INFO_CRASH_LEFT 0x8/// Present Right collision indicator
#define LE_ECALL_CRASH_INFO_PRESENT_CRASH_RIGHT 0x10/// Right collision indicator
#define LE_ECALL_CRASH_INFO_CRASH_RIGHT 0x20/// Present indicator
#define LE_ECALL_CRASH_INFO_PRESENT_CRASH_REAR 0x40/// Rear impact indicator.
#define LE_ECALL_CRASH_INFO_CRASH_REAR 0x80/// Present Rollover indicator.
#define LE_ECALL_CRASH_INFO_PRESENT_CRASH_ROLLOVER 0x100/// Rollover indicator.
#define LE_ECALL_CRASH_INFO_CRASH_ROLLOVER 0x200/// Present Side collision indicator.
#define LE_ECALL_CRASH_INFO_PRESENT_CRASH_SIDE 0x400/// Side collision indicator.
#define LE_ECALL_CRASH_INFO_CRASH_SIDE 0x800/// Present Front or side collision indicator.
#define LE_ECALL_CRASH_INFO_PRESENT_CRASH_FRONT_OR_SIDE 0x1000/// Front or side collision indicator.
#define LE_ECALL_CRASH_INFO_CRASH_FRONT_OR_SIDE 0x2000/// Present Other types of damage indicator.
#define LE_ECALL_CRASH_INFO_PRESENT_CRASH_ANOTHER_TYPE 0x4000/// Other types of damage indicator.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED bool ifgen_le_ecall_HasLocalBinding
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED void ifgen_le_ecall_InitCommonData
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_OpenSession
(
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ForceOnlyMode
(
    le_msg_SessionRef_t _ifgen_sessionRef
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ForcePersistentOnlyMode
(
    le_msg_SessionRef_t _ifgen_sessionRef
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ExitOnlyMode
(
    le_msg_SessionRef_t _ifgen_sessionRef
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetConfiguredOperationMode
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_ecall_StateChangeHandlerRef_t ifgen_le_ecall_AddStateChangeHandler
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED void ifgen_le_ecall_RemoveStateChangeHandler
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_ecall_CallRef_t ifgen_le_ecall_Create
(
    le_msg_SessionRef_t _ifgen_sessionRef
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED void ifgen_le_ecall_Delete
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetSystemStandard
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetSystemStandard
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdVersion
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint32_t msdVersion
        ///< [IN] Msd version
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetMsdVersion
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetVehicleType
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetVehicleType
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetVIN
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetVIN
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        char* vin,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetPropulsionType
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetPropulsionType
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdTxMode
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetMsdTxMode
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdPosition
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdPositionN1
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdPositionN2
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdPassengersCount
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ImportMsd
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ExportMsd
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SendMsd
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_StartAutomatic
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_StartManual
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_StartTest
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_End
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_ecall_State_t ifgen_le_ecall_GetState
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetPsapNumber
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetPsapNumber
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        char* psap,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_UseUSimNumbers
(
    le_msg_SessionRef_t _ifgen_sessionRef
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetNadDeregistrationTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t deregTime
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetNadDeregistrationTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetIntervalBetweenDialAttempts
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t pause
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetIntervalBetweenDialAttempts
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t* pausePtr
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetEraGlonassManualDialAttempts
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t attempts
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetEraGlonassAutoDialAttempts
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t attempts
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetEraGlonassDialDuration
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t duration
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetEraGlonassFallbackTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t duration
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetEraGlonassAutoAnswerTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetEraGlonassMSDMaxTransmissionTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetEraGlonassPostTestRegistrationTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetEraGlonassManualDialAttempts
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetEraGlonassAutoDialAttempts
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t* attemptsPtr
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetEraGlonassDialDuration
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetEraGlonassFallbackTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t* durationPtr
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetEraGlonassAutoAnswerTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetEraGlonassMSDMaxTransmissionTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_GetEraGlonassPostTestRegistrationTime
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdEraGlonassCrashSeverity
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ResetMsdEraGlonassCrashSeverity
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdEraGlonassDiagnosticResult
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ResetMsdEraGlonassDiagnosticResult
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdEraGlonassCrashInfo
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ResetMsdEraGlonassCrashInfo
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_SetMsdEraGlonassCoordinateSystemType
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef,
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_ResetMsdEraGlonassCoordinateSystemType
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_mcc_TerminationReason_t ifgen_le_ecall_GetTerminationReason
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED int32_t ifgen_le_ecall_GetPlatformSpecificTerminationCode
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_ecall_CallRef_t ecallRef
        ///< [IN] eCall reference.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_ecall_TerminateRegistration
(
    le_msg_SessionRef_t _ifgen_sessionRef
);

#endif // LE_ECALL_COMMON_H_INCLUDE_GUARD
