 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_ecall_ClientData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_ecall_ClientHandlers,
    LE_MEM_BLOCKS(le_ecall_ClientData, HIGH_CLIENT_DATA_COUNT));
...
)
{
    ...
    _LOCK;
    {
        if (!_ClientDataPool)
        {
            ...
            _ClientDataPool = le_mem_InitStaticPool(le_ecall_ClientData,
                                                    HIGH_CLIENT_DATA_COUNT,
                                                    sizeof(_ClientData_t));
        }
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(le_ecall_ClientHandlers,
                                                  LE_MEM_BLOCKS(le_ecall_ClientData,
                                                                HIGH_CLIENT_DATA_COUNT));
        }
...
)
{
    ...
    _msgPtr->id = _MSGID_le_ecall_ForceOnlyMode;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_ForcePersistentOnlyMode;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_ExitOnlyMode;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetConfiguredOperationMode;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(opModePtr)) << 0);
    ...
    // Unpack any "out" parameters
    if (opModePtr &&
        (!le_ecall_UnpackOpMode( &_msgBufPtr,
                                               opModePtr )))
    {
        goto error_unpack;
    }
...
static void _Handle_ifgen_le_ecall_AddStateChangeHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    le_ecall_State_t state = (le_ecall_State_t) 0;

    // Pull out additional data from the client data pointer
    le_ecall_StateChangeHandlerFunc_t _handlerRef_ifgen_le_ecall_AddStateChangeHandler =
        (le_ecall_StateChangeHandlerFunc_t)_clientDataPtr->handlerPtr;
    ...
    if (!le_ecall_UnpackState( &_msgBufPtr,
                                               &state ))
    {
        goto error_unpack;
    }
    ...
    if ( _handlerRef_ifgen_le_ecall_AddStateChangeHandler != NULL )
    {
        _handlerRef_ifgen_le_ecall_AddStateChangeHandler(ecallRef, state, contextPtr );
    }
    else
    {
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_RemoveStateChangeHandler;
    _msgBufPtr = _msgPtr->buffer;
    ...
    _UNLOCK
    handlerRef = (le_ecall_StateChangeHandlerRef_t)
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_Create;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_Delete;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetSystemStandard;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetSystemStandard;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(systemStandardPtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
    ...
    if (systemStandardPtr &&
        (!le_ecall_UnpackSystemStandard( &_msgBufPtr,
                                               systemStandardPtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdVersion;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetMsdVersion;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(msdVersionPtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetVehicleType;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetVehicleType;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(vehicleTypePtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
    ...
    // Unpack any "out" parameters
    if (vehicleTypePtr &&
        (!le_ecall_UnpackMsdVehicleType( &_msgBufPtr,
                                               vehicleTypePtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Range check values, if appropriate
    if ( strnlen(vin, 17) > 17 )
    {
        LE_FATAL("strnlen(vin, 17) > 17");
    }
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetVIN;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetVIN;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(vin)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));

    // Pack the input parameters
    if (vin)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, (vinSize-1) ));
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetPropulsionType;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetPropulsionType;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(propulsionTypePtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
    ...
    if (propulsionTypePtr &&
        (!le_ecall_UnpackPropulsionTypeBitMask( &_msgBufPtr,
                                               propulsionTypePtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdTxMode;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetMsdTxMode;
    _msgBufPtr = _msgPtr->buffer;
    ...
    // Unpack any "out" parameters
    if (modePtr &&
        (!le_ecall_UnpackMsdTxMode( &_msgBufPtr,
                                               modePtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdPosition;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdPositionN1;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdPositionN2;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdPassengersCount;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    if ( (NULL == msdPtr) &&
         (0 != msdSize) )
    {
        LE_FATAL("If msdPtr is NULL "
                 "msdSize must be zero");
    }
    if ( msdSize > 140 )
    {
        LE_FATAL("msdSize > 140");
    }
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_ImportMsd;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_ExportMsd;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(msdPtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
    ...
    if (msdPtr)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, (*msdSizePtr) ));
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SendMsd;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_StartAutomatic;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_StartManual;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_StartTest;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_End;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetState;
    _msgBufPtr = _msgPtr->buffer;
    ...
    // Unpack the result first
    if (!le_ecall_UnpackState( &_msgBufPtr, &_result ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    // Range check values, if appropriate
    if ( strnlen(psap, 17) > 17 )
    {
        LE_FATAL("strnlen(psap, 17) > 17");
    }
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetPsapNumber;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetPsapNumber;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(psap)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));

    // Pack the input parameters
    if (psap)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, (psapSize-1) ));
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_UseUSimNumbers;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetNadDeregistrationTime;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetNadDeregistrationTime;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(deregTimePtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetIntervalBetweenDialAttempts;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetIntervalBetweenDialAttempts;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(pausePtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetEraGlonassManualDialAttempts;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetEraGlonassAutoDialAttempts;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetEraGlonassDialDuration;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetEraGlonassFallbackTime;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetEraGlonassAutoAnswerTime;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetEraGlonassMSDMaxTransmissionTime;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetEraGlonassPostTestRegistrationTime;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetEraGlonassManualDialAttempts;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(attemptsPtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetEraGlonassAutoDialAttempts;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetEraGlonassDialDuration;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(durationPtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetEraGlonassFallbackTime;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetEraGlonassAutoAnswerTime;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(autoAnswerTimePtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetEraGlonassMSDMaxTransmissionTime;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(msdMaxTransTimePtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetEraGlonassPostTestRegistrationTime;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(postTestRegTimePtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdEraGlonassCrashSeverity;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_ResetMsdEraGlonassCrashSeverity;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdEraGlonassDiagnosticResult;
    _msgBufPtr = _msgPtr->buffer;
    ...
    LE_ASSERT(le_pack_PackReference( &_msgBufPtr,
                                                  ecallRef ));
    LE_ASSERT(le_ecall_PackDiagnosticResultBitMask( &_msgBufPtr,
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_ResetMsdEraGlonassDiagnosticResult;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdEraGlonassCrashInfo;
    _msgBufPtr = _msgPtr->buffer;
    ...
    LE_ASSERT(le_pack_PackReference( &_msgBufPtr,
                                                  ecallRef ));
    LE_ASSERT(le_ecall_PackCrashInfoBitMask( &_msgBufPtr,
                                                  crashInfoMask ));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_ResetMsdEraGlonassCrashInfo;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_SetMsdEraGlonassCoordinateSystemType;
    _msgBufPtr = _msgPtr->buffer;
    ...
    LE_ASSERT(le_pack_PackReference( &_msgBufPtr,
                                                  ecallRef ));
    LE_ASSERT(le_ecall_PackMsdCoordinateType( &_msgBufPtr,
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_ResetMsdEraGlonassCoordinateSystemType;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetTerminationReason;
    _msgBufPtr = _msgPtr->buffer;
    ...
    // Unpack the result first
    if (!le_mcc_UnpackTerminationReason( &_msgBufPtr, &_result ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_GetPlatformSpecificTerminationCode;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_ecall_TerminateRegistration;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_ecall_AddStateChangeHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_ifgen_le_ecall_AddStateChangeHandler, msgRef, clientDataPtr);
            break;
