 ...
 * ====================== WARNING ======================
 */
#ifndef LE_MCC_COMMON_H_INCLUDE_GUARD
#define LE_MCC_COMMON_H_INCLUDE_GUARD
...
#define IFGEN_LE_MCC_PROTOCOL_ID "bf43202a0369b12bb827e1bc4724bb41"
#define IFGEN_LE_MCC_MSG_SIZE 33
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED bool ifgen_le_mcc_HasLocalBinding
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED void ifgen_le_mcc_InitCommonData
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_OpenSession
(
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_mcc_CallRef_t ifgen_le_mcc_Create
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_Delete
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_Start
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED bool ifgen_le_mcc_IsConnected
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_GetRemoteTel
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_mcc_TerminationReason_t ifgen_le_mcc_GetTerminationReason
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef
        ///< [IN] The call reference to read from.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED int32_t ifgen_le_mcc_GetPlatformSpecificTerminationCode
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef
        ///< [IN] The call reference to read from.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_Answer
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_HangUp
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef
        ///< [IN] The call to end.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_HangUpAll
(
    le_msg_SessionRef_t _ifgen_sessionRef
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_GetCallerIdRestrict
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef,
        ///< [IN] The call reference.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_SetCallerIdRestrict
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef,
        ///< [IN] The call reference.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_mcc_CallEventHandlerRef_t ifgen_le_mcc_AddCallEventHandler
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED void ifgen_le_mcc_RemoveCallEventHandler
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_SetCallWaitingService
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        bool active
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_GetCallWaitingService
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        bool* activePtr
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_ActivateCall
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_mcc_CallRef_t callRef
        ///< [IN] The call reference.
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_SetAmrWbCapability
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        bool enable
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_mcc_GetAmrWbCapability
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        bool* enabledPtr
...
#endif // LE_MCC_COMMON_H_INCLUDE_GUARD
