...
#ifndef DHUB_INTERFACE_H_INCLUDE_GUARD
#define DHUB_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*dhub_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t dhub_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_FULL_API void dhub_SetServerDisconnectHandler
(
    dhub_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
#define DHUB_MAX_RESOURCE_PATH_LEN IO_MAX_RESOURCE_PATH_LEN
 ...
 */
//--------------------------------------------------------------------------------------------------
#define DHUB_MAX_STRING_VALUE_LEN IO_MAX_STRING_VALUE_LEN
 ...
 */
//--------------------------------------------------------------------------------------------------
#define DHUB_MAX_UNITS_NAME_LEN IO_MAX_UNITS_NAME_LEN
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef io_DataType_t dhub_DataType_t;
#define DHUB_DATA_TYPE_TRIGGER   IO_DATA_TYPE_TRIGGER        ///< trigger
#define DHUB_DATA_TYPE_BOOLEAN   IO_DATA_TYPE_BOOLEAN        ///< Boolean
#define DHUB_DATA_TYPE_NUMERIC   IO_DATA_TYPE_NUMERIC        ///< numeric (floating point number)
#define DHUB_DATA_TYPE_STRING   IO_DATA_TYPE_STRING        ///< string
#define DHUB_DATA_TYPE_JSON   IO_DATA_TYPE_JSON        ///< JSON
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef io_TriggerPushHandlerFunc_t dhub_TriggerPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhub_TriggerPush'
 */
//--------------------------------------------------------------------------------------------------
typedef io_TriggerPushHandlerRef_t dhub_TriggerPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef io_BooleanPushHandlerFunc_t dhub_BooleanPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhub_BooleanPush'
 */
//--------------------------------------------------------------------------------------------------
typedef io_BooleanPushHandlerRef_t dhub_BooleanPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef io_NumericPushHandlerFunc_t dhub_NumericPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhub_NumericPush'
 */
//--------------------------------------------------------------------------------------------------
typedef io_NumericPushHandlerRef_t dhub_NumericPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef io_StringPushHandlerFunc_t dhub_StringPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhub_StringPush'
 */
//--------------------------------------------------------------------------------------------------
typedef io_StringPushHandlerRef_t dhub_StringPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef io_JsonPushHandlerFunc_t dhub_JsonPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhub_JsonPush'
 */
//--------------------------------------------------------------------------------------------------
typedef io_JsonPushHandlerRef_t dhub_JsonPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef io_UpdateStartEndHandlerFunc_t dhub_UpdateStartEndHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhub_UpdateStartEnd'
 */
//--------------------------------------------------------------------------------------------------
typedef io_UpdateStartEndHandlerRef_t dhub_UpdateStartEndHandlerRef_t;
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'dhub_TriggerPush'
 */
//--------------------------------------------------------------------------------------------------
dhub_TriggerPushHandlerRef_t dhub_AddTriggerPushHandler
(
    const char* LE_NONNULL path,
        ///< [IN] Resource path within the client app's namespace.
    dhub_TriggerPushHandlerFunc_t callbackPtr,
        ///< [IN]
    void* contextPtr
        ///< [IN]
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'dhub_TriggerPush'
 */
//--------------------------------------------------------------------------------------------------
void dhub_RemoveTriggerPushHandler
(
    dhub_TriggerPushHandlerRef_t handlerRef
        ///< [IN]
);

//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'dhub_BooleanPush'
 */
//--------------------------------------------------------------------------------------------------
dhub_BooleanPushHandlerRef_t dhub_AddBooleanPushHandler
(
    const char* LE_NONNULL path,
        ///< [IN] Resource path within the client app's namespace.
    dhub_BooleanPushHandlerFunc_t callbackPtr,
        ///< [IN]
    void* contextPtr
        ///< [IN]
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'dhub_BooleanPush'
 */
//--------------------------------------------------------------------------------------------------
void dhub_RemoveBooleanPushHandler
(
    dhub_BooleanPushHandlerRef_t handlerRef
        ///< [IN]
);

//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'dhub_NumericPush'
 */
//--------------------------------------------------------------------------------------------------
dhub_NumericPushHandlerRef_t dhub_AddNumericPushHandler
(
    const char* LE_NONNULL path,
        ///< [IN] Resource path within the client app's namespace.
    dhub_NumericPushHandlerFunc_t callbackPtr,
        ///< [IN]
    void* contextPtr
        ///< [IN]
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'dhub_NumericPush'
 */
//--------------------------------------------------------------------------------------------------
void dhub_RemoveNumericPushHandler
(
    dhub_NumericPushHandlerRef_t handlerRef
        ///< [IN]
);

//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'dhub_StringPush'
 */
//--------------------------------------------------------------------------------------------------
dhub_StringPushHandlerRef_t dhub_AddStringPushHandler
(
    const char* LE_NONNULL path,
        ///< [IN] Resource path within the client app's namespace.
    dhub_StringPushHandlerFunc_t callbackPtr,
        ///< [IN]
    void* contextPtr
        ///< [IN]
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'dhub_StringPush'
 */
//--------------------------------------------------------------------------------------------------
void dhub_RemoveStringPushHandler
(
    dhub_StringPushHandlerRef_t handlerRef
        ///< [IN]
);

//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'dhub_JsonPush'
 */
//--------------------------------------------------------------------------------------------------
dhub_JsonPushHandlerRef_t dhub_AddJsonPushHandler
(
    const char* LE_NONNULL path,
        ///< [IN] Resource path within the client app's namespace.
    dhub_JsonPushHandlerFunc_t callbackPtr,
        ///< [IN]
    void* contextPtr
        ///< [IN]
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'dhub_JsonPush'
 */
//--------------------------------------------------------------------------------------------------
void dhub_RemoveJsonPushHandler
(
    dhub_JsonPushHandlerRef_t handlerRef
        ///< [IN]
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'dhub_UpdateStartEnd'
 */
//--------------------------------------------------------------------------------------------------
dhub_UpdateStartEndHandlerRef_t dhub_AddUpdateStartEndHandler
(
    dhub_UpdateStartEndHandlerFunc_t callbackPtr,
        ///< [IN]
    void* contextPtr
        ///< [IN]
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'dhub_UpdateStartEnd'
 */
//--------------------------------------------------------------------------------------------------
void dhub_RemoveUpdateStartEndHandler
(
    dhub_UpdateStartEndHandlerRef_t handlerRef
        ///< [IN]
);

#endif // DHUB_INTERFACE_H_INCLUDE_GUARD
