...
)
{
    ...
    uint8_t* _msgBufStartPtr = _msgBufPtr;
    // Declare temporaries for input parameters
    le_port_DeviceRef_t devRef = NULL;
...
)
{
    ...
    // Define storage for output parameters
    le_atServer_DeviceRef_t atServerDevRefBuffer = NULL;
...
)
{
    ...
    // Define storage for output parameters
    le_port_DeviceRef_t devRefBuffer = NULL;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_port_Request :
            Handle_le_port_Request(msgRef);
            break;
        case _MSGID_le_port_SetDataMode :
            Handle_le_port_SetDataMode(msgRef);
            break;
        case _MSGID_le_port_SetCommandMode :
            Handle_le_port_SetCommandMode(msgRef);
            break;
        case _MSGID_le_port_Release :
            Handle_le_port_Release(msgRef);
            break;
        case _MSGID_le_port_GetPortReference :
            Handle_le_port_GetPortReference(msgRef);
            break;
