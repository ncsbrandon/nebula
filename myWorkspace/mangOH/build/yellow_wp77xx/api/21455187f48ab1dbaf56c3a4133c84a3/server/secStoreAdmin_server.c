...
)
{
    ...
    uint8_t* _msgBufStartPtr = _msgBufPtr;
    // Declare temporaries for input parameters
    secStoreAdmin_IterRef_t iterRef = NULL;
...
)
{
    ...
    // Define storage for output parameters
    uint64_t totalSizeBuffer = 0;
    uint64_t *totalSizePtr = &totalSizeBuffer;
    uint64_t freeSizeBuffer = 0;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_secStoreAdmin_CreateIter :
            Handle_secStoreAdmin_CreateIter(msgRef);
            break;
        case _MSGID_secStoreAdmin_DeleteIter :
            Handle_secStoreAdmin_DeleteIter(msgRef);
            break;
        case _MSGID_secStoreAdmin_Next :
            Handle_secStoreAdmin_Next(msgRef);
            break;
        case _MSGID_secStoreAdmin_GetEntry :
            Handle_secStoreAdmin_GetEntry(msgRef);
            break;
        case _MSGID_secStoreAdmin_Write :
            Handle_secStoreAdmin_Write(msgRef);
            break;
        case _MSGID_secStoreAdmin_Read :
            Handle_secStoreAdmin_Read(msgRef);
            break;
        case _MSGID_secStoreAdmin_CopyMetaTo :
            Handle_secStoreAdmin_CopyMetaTo(msgRef);
            break;
        case _MSGID_secStoreAdmin_Delete :
            Handle_secStoreAdmin_Delete(msgRef);
            break;
        case _MSGID_secStoreAdmin_GetSize :
            Handle_secStoreAdmin_GetSize(msgRef);
            break;
        case _MSGID_secStoreAdmin_GetTotalSpace :
            Handle_secStoreAdmin_GetTotalSpace(msgRef);
            break;
