 ...
 * few functions remains to get non sensitive information about secure storage. In order to enable
 * the secure storage admin API, Legato must be compiled using the @c SECSTOREADMIN flag.
 * @verbatim
 make distclean
 ...
 *
 * Even if the Secure Storage Admin API is disabled the following two functions are always
 * available:
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_FULL_API void secStoreAdmin_SetServerDisconnectHandler
(
