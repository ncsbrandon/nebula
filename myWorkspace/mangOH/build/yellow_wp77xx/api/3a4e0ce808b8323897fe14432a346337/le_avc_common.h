...
#define IFGEN_LE_AVC_PROTOCOL_ID "658699438f36e61a5791638b9905361c"
#define IFGEN_LE_AVC_MSG_SIZE 529
...
typedef enum
{
    ...
    LE_AVC_ERR_BAD_PACKAGE = 1,
        ///< Encountered a bad package, package download can not be
        ///< resumed.
    LE_AVC_ERR_INTERNAL = 2,
        ///< Something failed while doing install/download, package
    ...
    LE_AVC_ERR_RAM = 4,
        ///< RAM issue during package download, package download can be
        ///< resumed but a platform reboot is requires.
    LE_AVC_ERR_NETWORK = 5,
        ///< Network issue during package download (IP issues), package
        ///< download can be resumed.
    LE_AVC_ERR_FLASH = 6,
        ///< Flash issue during package download, package download can
        ///< not be resumed.
    LE_AVC_ERR_PKG_TOO_BIG = 7
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_avc_CommInfoHandlerRef_t ifgen_le_avc_AddCommInfoHandler
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED void ifgen_le_avc_RemoveCommInfoHandler
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_avc_DeferConnect
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_avc_AcceptReboot
(
    le_msg_SessionRef_t _ifgen_sessionRef
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_avc_DeferReboot
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint32_t deferMinutes
        ///< [IN]
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_avc_CredentialStatus_t ifgen_le_avc_GetCredentialStatus
(
    le_msg_SessionRef_t _ifgen_sessionRef
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_avc_SetUserAgreement
(
    le_msg_SessionRef_t _ifgen_sessionRef,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_avc_GetUserAgreement
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_avc_UserAgreement_t updateStatus,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_avc_ReadLwm2mResource
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        uint16_t objectId,
