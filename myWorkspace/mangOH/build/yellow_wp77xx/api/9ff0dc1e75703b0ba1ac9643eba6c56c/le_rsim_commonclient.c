 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_rsim_ClientHandlers,
    LE_MEM_BLOCKS(le_rsim_ClientData, HIGH_CLIENT_DATA_COUNT));
    ...
    _LOCK;
    {
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(le_rsim_ClientHandlers,
                                                  LE_MEM_BLOCKS(le_rsim_ClientData,
                                                                HIGH_CLIENT_DATA_COUNT));
        }
...
)
{
    ...
    le_rsim_MessageHandlerFunc_t _handlerRef_ifgen_le_rsim_AddMessageHandler =
        (le_rsim_MessageHandlerFunc_t)_clientDataPtr->handlerPtr;
...
)
{
    ...
    // Pull out additional data from the client data pointer
    le_rsim_CallbackHandlerFunc_t _handlerRef_ifgen_le_rsim_SendMessage =
        (le_rsim_CallbackHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
