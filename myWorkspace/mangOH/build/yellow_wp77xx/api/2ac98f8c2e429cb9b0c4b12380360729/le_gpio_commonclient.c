 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_gpio_ClientHandlers,
    LE_MEM_BLOCKS(le_gpio_ClientData, HIGH_CLIENT_DATA_COUNT));
    ...
    _LOCK;
    {
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(le_gpio_ClientHandlers,
                                                  LE_MEM_BLOCKS(le_gpio_ClientData,
                                                                HIGH_CLIENT_DATA_COUNT));
        }
...
)
{
    ...
    le_gpio_ChangeCallbackFunc_t _handlerRef_ifgen_le_gpio_AddChangeEventHandler =
        (le_gpio_ChangeCallbackFunc_t)_clientDataPtr->handlerPtr;
