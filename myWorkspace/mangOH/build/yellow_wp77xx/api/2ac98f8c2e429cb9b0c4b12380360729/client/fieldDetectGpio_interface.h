...
#ifndef FIELDDETECTGPIO_INTERFACE_H_INCLUDE_GUARD
#define FIELDDETECTGPIO_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*fieldDetectGpio_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
void fieldDetectGpio_ConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_FULL_API void fieldDetectGpio_SetServerDisconnectHandler
(
    fieldDetectGpio_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
void fieldDetectGpio_DisconnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_Polarity_t fieldDetectGpio_Polarity_t;
#define FIELDDETECTGPIO_ACTIVE_HIGH   LE_GPIO_ACTIVE_HIGH        ///< GPIO active-high, output is 1
#define FIELDDETECTGPIO_ACTIVE_LOW   LE_GPIO_ACTIVE_LOW        ///< GPIO active-low, output is 0
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_ChangeCallbackFunc_t fieldDetectGpio_ChangeCallbackFunc_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_Edge_t fieldDetectGpio_Edge_t;
#define FIELDDETECTGPIO_EDGE_NONE   LE_GPIO_EDGE_NONE        ///< No edge detection
#define FIELDDETECTGPIO_EDGE_RISING   LE_GPIO_EDGE_RISING        ///< Notify when voltage goes from low to high.
#define FIELDDETECTGPIO_EDGE_FALLING   LE_GPIO_EDGE_FALLING        ///< Notify when voltage goes from high to low.
#define FIELDDETECTGPIO_EDGE_BOTH   LE_GPIO_EDGE_BOTH        ///< Notify when pin voltage changes state in either direction.


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'fieldDetectGpio_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_ChangeEventHandlerRef_t fieldDetectGpio_ChangeEventHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_PullUpDown_t fieldDetectGpio_PullUpDown_t;
#define FIELDDETECTGPIO_PULL_OFF   LE_GPIO_PULL_OFF        ///< Neither resistor is enabled
#define FIELDDETECTGPIO_PULL_DOWN   LE_GPIO_PULL_DOWN        ///< Pulldown resistor is enabled
#define FIELDDETECTGPIO_PULL_UP   LE_GPIO_PULL_UP        ///< Pullup resistor is enabled
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_SetInput
(
    fieldDetectGpio_Polarity_t polarity
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_SetPushPullOutput
(
    fieldDetectGpio_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_SetTriStateOutput
(
    fieldDetectGpio_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_SetOpenDrainOutput
(
    fieldDetectGpio_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'fieldDetectGpio_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
fieldDetectGpio_ChangeEventHandlerRef_t fieldDetectGpio_AddChangeEventHandler
(
    fieldDetectGpio_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    fieldDetectGpio_ChangeCallbackFunc_t handlerPtr,
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'fieldDetectGpio_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void fieldDetectGpio_RemoveChangeEventHandler
(
    fieldDetectGpio_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_SetEdgeSense
(
    fieldDetectGpio_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t fieldDetectGpio_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
fieldDetectGpio_Edge_t fieldDetectGpio_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
fieldDetectGpio_Polarity_t fieldDetectGpio_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
fieldDetectGpio_PullUpDown_t fieldDetectGpio_GetPullUpDown
(
    void
);

#endif // FIELDDETECTGPIO_INTERFACE_H_INCLUDE_GUARD
