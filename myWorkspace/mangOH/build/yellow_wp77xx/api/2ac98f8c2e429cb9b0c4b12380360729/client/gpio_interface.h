...
#ifndef GPIO_INTERFACE_H_INCLUDE_GUARD
#define GPIO_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*gpio_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_TryConnectService
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_FULL_API void gpio_SetServerDisconnectHandler
(
    gpio_DisconnectHandler_t disconnectHandler,
    void *contextPtr
);
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_Polarity_t gpio_Polarity_t;
#define GPIO_ACTIVE_HIGH   LE_GPIO_ACTIVE_HIGH        ///< GPIO active-high, output is 1
#define GPIO_ACTIVE_LOW   LE_GPIO_ACTIVE_LOW        ///< GPIO active-low, output is 0
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_ChangeCallbackFunc_t gpio_ChangeCallbackFunc_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_Edge_t gpio_Edge_t;
#define GPIO_EDGE_NONE   LE_GPIO_EDGE_NONE        ///< No edge detection
#define GPIO_EDGE_RISING   LE_GPIO_EDGE_RISING        ///< Notify when voltage goes from low to high.
#define GPIO_EDGE_FALLING   LE_GPIO_EDGE_FALLING        ///< Notify when voltage goes from high to low.
#define GPIO_EDGE_BOTH   LE_GPIO_EDGE_BOTH        ///< Notify when pin voltage changes state in either direction.


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'gpio_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_ChangeEventHandlerRef_t gpio_ChangeEventHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_PullUpDown_t gpio_PullUpDown_t;
#define GPIO_PULL_OFF   LE_GPIO_PULL_OFF        ///< Neither resistor is enabled
#define GPIO_PULL_DOWN   LE_GPIO_PULL_DOWN        ///< Pulldown resistor is enabled
#define GPIO_PULL_UP   LE_GPIO_PULL_UP        ///< Pullup resistor is enabled
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_SetPushPullOutput
(
    gpio_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_SetTriStateOutput
(
    gpio_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_SetOpenDrainOutput
(
    gpio_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_DisableResistors
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'gpio_ChangeEvent'
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
gpio_ChangeEventHandlerRef_t gpio_AddChangeEventHandler
(
    gpio_Edge_t trigger,
        ///< [IN] Change(s) that should trigger the callback to be called.
    gpio_ChangeCallbackFunc_t handlerPtr,
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'gpio_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void gpio_RemoveChangeEventHandler
(
    gpio_ChangeEventHandlerRef_t handlerRef
        ///< [IN]
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t gpio_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
gpio_Polarity_t gpio_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
gpio_PullUpDown_t gpio_GetPullUpDown
(
    void
);

#endif // GPIO_INTERFACE_H_INCLUDE_GUARD
