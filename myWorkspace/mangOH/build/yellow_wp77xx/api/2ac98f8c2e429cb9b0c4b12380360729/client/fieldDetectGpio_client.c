...
#include "fieldDetectGpio_interface.h"
#include "le_gpio_messages.h"
#include "fieldDetectGpio_service.h"
...
typedef struct
{
    ...
    fieldDetectGpio_DisconnectHandler_t disconnectHandler; ///< Disconnect handler for this thread
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(fieldDetectGpio_ClientThreadData,
...
)
{
    ...
    else
    {
        ...
        LE_FATAL_IF(clientThreadPtr==NULL,
                    "fieldDetectGpio_ConnectService() not called for current thread");
...
static void InitCommonData(void)
{
    ...
    _ClientThreadDataPool = le_mem_InitStaticPool(fieldDetectGpio_ClientThreadData,
                                                  LE_CDATA_COMPONENT_COUNT,
                                                  sizeof(_ClientThreadData_t));
...
)
{
    ...
    LE_FATAL("Component for fieldDetectGpio disconnected\n");
}
 ...
 */
//--------------------------------------------------------------------------------------------------
void fieldDetectGpio_SetServerDisconnectHandler
(
