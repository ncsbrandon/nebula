 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_gpioPin7_ServerData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_gpioPin7_ServerHandlers,
    LE_MEM_BLOCKS(le_gpioPin7_ServerCmd, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(le_gpioPin7_ServerData,
                                            HIGH_SERVER_DATA_COUNT,
                                            sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    _HandlerRefMap = le_ref_InitStaticMap(le_gpioPin7_ServerHandlers,
                        LE_MEM_BLOCKS(le_gpioPin7_ServerData, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    le_gpioPin7_Polarity_t polarity = (le_gpioPin7_Polarity_t) 0;
...
)
{
    ...
    uint8_t* _msgBufStartPtr = _msgBufPtr;
    // Declare temporaries for input parameters
    le_gpioPin7_Edge_t trigger = (le_gpioPin7_Edge_t) 0;
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin7_ChangeEventHandlerRef_t handlerRef = NULL;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpio_SetInput :
            Handle_le_gpioPin7_SetInput(msgRef);
            break;
        case _MSGID_le_gpio_SetPushPullOutput :
            Handle_le_gpioPin7_SetPushPullOutput(msgRef);
            break;
        case _MSGID_le_gpio_SetTriStateOutput :
            Handle_le_gpioPin7_SetTriStateOutput(msgRef);
            break;
        case _MSGID_le_gpio_SetOpenDrainOutput :
            Handle_le_gpioPin7_SetOpenDrainOutput(msgRef);
            break;
        case _MSGID_le_gpio_EnablePullUp :
            Handle_le_gpioPin7_EnablePullUp(msgRef);
            break;
        case _MSGID_le_gpio_EnablePullDown :
            Handle_le_gpioPin7_EnablePullDown(msgRef);
            break;
        case _MSGID_le_gpio_DisableResistors :
            Handle_le_gpioPin7_DisableResistors(msgRef);
            break;
        case _MSGID_le_gpio_Activate :
            Handle_le_gpioPin7_Activate(msgRef);
            break;
        case _MSGID_le_gpio_Deactivate :
            Handle_le_gpioPin7_Deactivate(msgRef);
            break;
        case _MSGID_le_gpio_SetHighZ :
            Handle_le_gpioPin7_SetHighZ(msgRef);
            break;
        case _MSGID_le_gpio_Read :
            Handle_le_gpioPin7_Read(msgRef);
            break;
        case _MSGID_le_gpio_AddChangeEventHandler :
            Handle_le_gpioPin7_AddChangeEventHandler(msgRef);
            break;
        case _MSGID_le_gpio_RemoveChangeEventHandler :
            Handle_le_gpioPin7_RemoveChangeEventHandler(msgRef);
            break;
        case _MSGID_le_gpio_SetEdgeSense :
            Handle_le_gpioPin7_SetEdgeSense(msgRef);
            break;
        case _MSGID_le_gpio_DisableEdgeSense :
            Handle_le_gpioPin7_DisableEdgeSense(msgRef);
            break;
        case _MSGID_le_gpio_IsOutput :
            Handle_le_gpioPin7_IsOutput(msgRef);
            break;
        case _MSGID_le_gpio_IsInput :
            Handle_le_gpioPin7_IsInput(msgRef);
            break;
        case _MSGID_le_gpio_GetEdgeSense :
            Handle_le_gpioPin7_GetEdgeSense(msgRef);
            break;
        case _MSGID_le_gpio_GetPolarity :
            Handle_le_gpioPin7_GetPolarity(msgRef);
            break;
        case _MSGID_le_gpio_IsActive :
            Handle_le_gpioPin7_IsActive(msgRef);
            break;
        case _MSGID_le_gpio_GetPullUpDown :
            Handle_le_gpioPin7_GetPullUpDown(msgRef);
            break;
