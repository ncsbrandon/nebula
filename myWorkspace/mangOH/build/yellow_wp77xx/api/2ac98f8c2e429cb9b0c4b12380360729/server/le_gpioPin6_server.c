 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_gpioPin6_ServerData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_gpioPin6_ServerHandlers,
    LE_MEM_BLOCKS(le_gpioPin6_ServerCmd, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    _HandlerRefMap = le_ref_InitStaticMap(le_gpioPin6_ServerHandlers,
                        LE_MEM_BLOCKS(le_gpioPin6_ServerData, HIGH_SERVER_DATA_COUNT));
