 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_Polarity_t le_gpioPin60_Polarity_t;
#define LE_GPIOPIN60_ACTIVE_HIGH   LE_GPIO_ACTIVE_HIGH        ///< GPIO active-high, output is 1
#define LE_GPIOPIN60_ACTIVE_LOW   LE_GPIO_ACTIVE_LOW        ///< GPIO active-low, output is 0
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_ChangeCallbackFunc_t le_gpioPin60_ChangeCallbackFunc_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_Edge_t le_gpioPin60_Edge_t;
#define LE_GPIOPIN60_EDGE_NONE   LE_GPIO_EDGE_NONE        ///< No edge detection
#define LE_GPIOPIN60_EDGE_RISING   LE_GPIO_EDGE_RISING        ///< Notify when voltage goes from low to high.
#define LE_GPIOPIN60_EDGE_FALLING   LE_GPIO_EDGE_FALLING        ///< Notify when voltage goes from high to low.
#define LE_GPIOPIN60_EDGE_BOTH   LE_GPIO_EDGE_BOTH        ///< Notify when pin voltage changes state in either direction.
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_ChangeEventHandlerRef_t le_gpioPin60_ChangeEventHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef le_gpio_PullUpDown_t le_gpioPin60_PullUpDown_t;
#define LE_GPIOPIN60_PULL_OFF   LE_GPIO_PULL_OFF        ///< Neither resistor is enabled
#define LE_GPIOPIN60_PULL_DOWN   LE_GPIO_PULL_DOWN        ///< Pulldown resistor is enabled
#define LE_GPIOPIN60_PULL_UP   LE_GPIO_PULL_UP        ///< Pullup resistor is enabled
