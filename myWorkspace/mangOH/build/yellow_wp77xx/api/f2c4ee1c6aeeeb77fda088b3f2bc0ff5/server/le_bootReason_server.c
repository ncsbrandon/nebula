...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_bootReason_WasTimer :
            Handle_le_bootReason_WasTimer(msgRef);
            break;
        case _MSGID_le_bootReason_WasGpio :
            Handle_le_bootReason_WasGpio(msgRef);
            break;
        case _MSGID_le_bootReason_WasAdc :
            Handle_le_bootReason_WasAdc(msgRef);
            break;
