...
#ifndef DHUBADMIN_INTERFACE_H_INCLUDE_GUARD
#define DHUBADMIN_INTERFACE_H_INCLUDE_GUARD
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*dhubAdmin_DisconnectHandler_t)(void *);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_FULL_API void dhubAdmin_SetServerDisconnectHandler
(
 ...
 */
//--------------------------------------------------------------------------------------------------
#define DHUBADMIN_MAX_JSON_EXTRACTOR_LEN ADMIN_MAX_JSON_EXTRACTOR_LEN
 ...
 */
//--------------------------------------------------------------------------------------------------
#define DHUBADMIN_MAX_TRANSFORM_PARAMETERS ADMIN_MAX_TRANSFORM_PARAMETERS
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_EntryType_t dhubAdmin_EntryType_t;
#define DHUBADMIN_ENTRY_TYPE_NONE   ADMIN_ENTRY_TYPE_NONE        ///< Not an entry
#define DHUBADMIN_ENTRY_TYPE_NAMESPACE   ADMIN_ENTRY_TYPE_NAMESPACE        ///< Namespace
#define DHUBADMIN_ENTRY_TYPE_INPUT   ADMIN_ENTRY_TYPE_INPUT        ///< Input
#define DHUBADMIN_ENTRY_TYPE_OUTPUT   ADMIN_ENTRY_TYPE_OUTPUT        ///< Output
#define DHUBADMIN_ENTRY_TYPE_OBSERVATION   ADMIN_ENTRY_TYPE_OBSERVATION        ///< Observation
#define DHUBADMIN_ENTRY_TYPE_PLACEHOLDER   ADMIN_ENTRY_TYPE_PLACEHOLDER        ///< Placeholder
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_ResourceOperationType_t dhubAdmin_ResourceOperationType_t;
#define DHUBADMIN_RESOURCE_ADDED   ADMIN_RESOURCE_ADDED
#define DHUBADMIN_RESOURCE_REMOVED   ADMIN_RESOURCE_REMOVED
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_TransformType_t dhubAdmin_TransformType_t;
#define DHUBADMIN_OBS_TRANSFORM_TYPE_NONE   ADMIN_OBS_TRANSFORM_TYPE_NONE        ///< No transformation
#define DHUBADMIN_OBS_TRANSFORM_TYPE_MEAN   ADMIN_OBS_TRANSFORM_TYPE_MEAN        ///< Mean
#define DHUBADMIN_OBS_TRANSFORM_TYPE_STDDEV   ADMIN_OBS_TRANSFORM_TYPE_STDDEV        ///< Standard Deviation
#define DHUBADMIN_OBS_TRANSFORM_TYPE_MAX   ADMIN_OBS_TRANSFORM_TYPE_MAX        ///< Maximum value in buffer
#define DHUBADMIN_OBS_TRANSFORM_TYPE_MIN   ADMIN_OBS_TRANSFORM_TYPE_MIN        ///< Minimum value in buffer
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_TriggerPushHandlerFunc_t dhubAdmin_TriggerPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhubAdmin_TriggerPush'
 */
//--------------------------------------------------------------------------------------------------
typedef admin_TriggerPushHandlerRef_t dhubAdmin_TriggerPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_BooleanPushHandlerFunc_t dhubAdmin_BooleanPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhubAdmin_BooleanPush'
 */
//--------------------------------------------------------------------------------------------------
typedef admin_BooleanPushHandlerRef_t dhubAdmin_BooleanPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_NumericPushHandlerFunc_t dhubAdmin_NumericPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhubAdmin_NumericPush'
 */
//--------------------------------------------------------------------------------------------------
typedef admin_NumericPushHandlerRef_t dhubAdmin_NumericPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_StringPushHandlerFunc_t dhubAdmin_StringPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhubAdmin_StringPush'
 */
//--------------------------------------------------------------------------------------------------
typedef admin_StringPushHandlerRef_t dhubAdmin_StringPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_JsonPushHandlerFunc_t dhubAdmin_JsonPushHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhubAdmin_JsonPush'
 */
//--------------------------------------------------------------------------------------------------
typedef admin_JsonPushHandlerRef_t dhubAdmin_JsonPushHandlerRef_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef admin_ResourceTreeChangeHandlerFunc_t dhubAdmin_ResourceTreeChangeHandlerFunc_t;


//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'dhubAdmin_ResourceTreeChange'
 */
//--------------------------------------------------------------------------------------------------
typedef admin_ResourceTreeChangeHandlerRef_t dhubAdmin_ResourceTreeChangeHandlerRef_t;
...
#endif // DHUBADMIN_INTERFACE_H_INCLUDE_GUARD
