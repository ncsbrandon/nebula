...
#define _MAX_MSG_SIZE IFGEN_ADMIN_MSG_SIZE
...
)
{
    ...
    if (result)
    {
        *valuePtr = (admin_EntryType_t)value;
    }
    return result;
}
...
)
{
    ...
    if (result)
    {
        *valuePtr = (admin_ResourceOperationType_t)value;
    }
    return result;
}
...
)
{
    ...
    if (result)
    {
        *valuePtr = (admin_TransformType_t)value;
    }
    return result;
}
