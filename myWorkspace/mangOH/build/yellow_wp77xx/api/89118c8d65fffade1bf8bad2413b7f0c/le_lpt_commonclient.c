 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_lpt_ClientHandlers,
    LE_MEM_BLOCKS(le_lpt_ClientData, HIGH_CLIENT_DATA_COUNT));
    ...
    _LOCK;
    {
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(le_lpt_ClientHandlers,
                                                  LE_MEM_BLOCKS(le_lpt_ClientData,
                                                                HIGH_CLIENT_DATA_COUNT));
        }
...
)
{
    ...
    le_lpt_EDrxParamsChangeHandlerFunc_t _handlerRef_ifgen_le_lpt_AddEDrxParamsChangeHandler =
        (le_lpt_EDrxParamsChangeHandlerFunc_t)_clientDataPtr->handlerPtr;
