 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_temp_ClientData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_temp_ClientHandlers,
    LE_MEM_BLOCKS(le_temp_ClientData, HIGH_CLIENT_DATA_COUNT));
...
)
{
    ...
    _LOCK;
    {
        if (!_ClientDataPool)
        {
            ...
            _ClientDataPool = le_mem_InitStaticPool(le_temp_ClientData,
                                                    HIGH_CLIENT_DATA_COUNT,
                                                    sizeof(_ClientData_t));
        }
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(le_temp_ClientHandlers,
                                                  LE_MEM_BLOCKS(le_temp_ClientData,
                                                                HIGH_CLIENT_DATA_COUNT));
        }
...
)
{
    ...
    if (sensorName)
    {
        LE_ASSERT(le_pack_PackSize( &_msgBufPtr, (sensorNameSize-1) ));
    }
...
static void _Handle_ifgen_le_temp_AddThresholdEventHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    le_temp_ThresholdEventHandlerFunc_t _handlerRef_ifgen_le_temp_AddThresholdEventHandler =
        (le_temp_ThresholdEventHandlerFunc_t)_clientDataPtr->handlerPtr;
    ...
    if ( _handlerRef_ifgen_le_temp_AddThresholdEventHandler != NULL )
    {
        _handlerRef_ifgen_le_temp_AddThresholdEventHandler(sensor, threshold, contextPtr );
    }
    else
    {
...
)
{
    ...
    _clientDataPtr->handlerPtr = ThresholdEventHandlerPtr;
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_temp_ThresholdEventHandlerRef_t)
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_temp_AddThresholdEventHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_ifgen_le_temp_AddThresholdEventHandler, msgRef, clientDataPtr);
            break;
