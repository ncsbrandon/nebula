 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_temp_ServerData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_temp_ServerHandlers,
    LE_MEM_BLOCKS(le_temp_ServerCmd, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    _HandlerRefMap = le_ref_InitStaticMap(le_temp_ServerHandlers,
                        LE_MEM_BLOCKS(le_temp_ServerData, HIGH_SERVER_DATA_COUNT));
