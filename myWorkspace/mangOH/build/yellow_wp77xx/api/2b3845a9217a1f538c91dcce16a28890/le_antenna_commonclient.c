 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_antenna_ClientData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_antenna_ClientHandlers,
    LE_MEM_BLOCKS(le_antenna_ClientData, HIGH_CLIENT_DATA_COUNT));
...
)
{
    ...
    _LOCK;
    {
        if (!_ClientDataPool)
        {
            ...
            _ClientDataPool = le_mem_InitStaticPool(le_antenna_ClientData,
                                                    HIGH_CLIENT_DATA_COUNT,
                                                    sizeof(_ClientData_t));
        }
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(le_antenna_ClientHandlers,
                                                  LE_MEM_BLOCKS(le_antenna_ClientData,
                                                                HIGH_CLIENT_DATA_COUNT));
        }
...
)
{
    ...
    _msgPtr->id = _MSGID_le_antenna_Request;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_GetType;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(antennaTypePtr)) << 0);
    ...
    // Unpack any "out" parameters
    if (antennaTypePtr &&
        (!le_antenna_UnpackType( &_msgBufPtr,
                                               antennaTypePtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_SetShortLimit;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_GetShortLimit;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(shortLimitPtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_SetOpenLimit;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_GetOpenLimit;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(openLimitPtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
static void _Handle_ifgen_le_antenna_AddStatusEventHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    le_antenna_Status_t status = (le_antenna_Status_t) 0;

    // Pull out additional data from the client data pointer
    le_antenna_StatusHandlerFunc_t _handlerRef_ifgen_le_antenna_AddStatusEventHandler =
        (le_antenna_StatusHandlerFunc_t)_clientDataPtr->handlerPtr;
    ...
    if (!le_antenna_UnpackStatus( &_msgBufPtr,
                                               &status ))
    {
        goto error_unpack;
    }
    ...
    if ( _handlerRef_ifgen_le_antenna_AddStatusEventHandler != NULL )
    {
        _handlerRef_ifgen_le_antenna_AddStatusEventHandler(antennaRef, status, contextPtr );
    }
    else
    {
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_RemoveStatusEventHandler;
    _msgBufPtr = _msgPtr->buffer;
    ...
    _UNLOCK
    handlerRef = (le_antenna_StatusEventHandlerRef_t)
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_GetStatus;
    _msgBufPtr = _msgPtr->buffer;
    ...
    // Unpack any "out" parameters
    if (statusPtr &&
        (!le_antenna_UnpackStatus( &_msgBufPtr,
                                               statusPtr )))
    {
        goto error_unpack;
    }
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_SetExternalAdc;
    _msgBufPtr = _msgPtr->buffer;
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(_ifgen_sessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_antenna_GetExternalAdc;
    _msgBufPtr = _msgPtr->buffer;

    // Pack a list of outputs requested by the client.
    uint32_t _requiredOutputs = 0;
    _requiredOutputs |= ((!!(adcIdPtr)) << 0);
    LE_ASSERT(le_pack_PackUint32(&_msgBufPtr, _requiredOutputs));
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_antenna_AddStatusEventHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_ifgen_le_antenna_AddStatusEventHandler, msgRef, clientDataPtr);
            break;
