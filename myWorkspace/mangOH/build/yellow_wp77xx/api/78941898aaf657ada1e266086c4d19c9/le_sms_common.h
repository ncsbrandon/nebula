 ...
 * ====================== WARNING ======================
 */
#ifndef LE_SMS_COMMON_H_INCLUDE_GUARD
#define LE_SMS_COMMON_H_INCLUDE_GUARD
...
#define IFGEN_LE_SMS_PROTOCOL_ID "c5c2101fed1e179026272cdeaa4e7e32"
#define IFGEN_LE_SMS_MSG_SIZE 271
...
//--------------------------------------------------------------------------------------------------
/**
 * The PDU message can be up to 36 (header) + 140 (payload) bytes long for GSM.
 */
//--------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------
/**
 * The PDU message can be up to 255 bytes long for CDMA.
 */
//--------------------------------------------------------------------------------------------------
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_sms_SetTimeout
(
    le_msg_SessionRef_t _ifgen_sessionRef,
        le_sms_MsgRef_t msgRef,
...
#endif // LE_SMS_COMMON_H_INCLUDE_GUARD
