 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(query_ServerData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(query_ServerHandlers,
    LE_MEM_BLOCKS(query_ServerCmd, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(query_ServerData,
                                            HIGH_SERVER_DATA_COUNT,
                                            sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    _HandlerRefMap = le_ref_InitStaticMap(query_ServerHandlers,
                        LE_MEM_BLOCKS(query_ServerData, HIGH_SERVER_DATA_COUNT));
...
static void AsyncResponse_query_ReadBufferJson
(
    le_result_t result,
    void* contextPtr
)
{
    ...
    {
        LE_FATAL("Handler passed to query_ReadBufferJson() can't be called more than once");
    }
...
static void Handle_query_ReadBufferJson
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    outputFile = le_msg_GetFd(_msgRef);
    ...
    // Call the function
    le_result_t _result;
    _result  = query_ReadBufferJson ( 
        obsPath, 
        startAfter, 
        outputFile, AsyncResponse_query_ReadBufferJson, 
        contextPtr );
...
static void Handle_query_ReadBufferSampleTimestamp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    double timestampBuffer = 0;
    double *timestampPtr = &timestampBuffer;
    ...
    // Call the function
    le_result_t _result;
    _result  = query_ReadBufferSampleTimestamp ( 
        obsPath, 
        startAfter, 
        timestampPtr );
...
static void Handle_query_ReadBufferSampleBoolean
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = query_ReadBufferSampleBoolean ( 
        obsPath, 
        startAfter, 
        timestampPtr, 
        valuePtr );
...
static void Handle_query_ReadBufferSampleNumeric
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = query_ReadBufferSampleNumeric ( 
        obsPath, 
        startAfter, 
        timestampPtr, 
        valuePtr );
...
static void Handle_query_ReadBufferSampleString
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = query_ReadBufferSampleString ( 
        obsPath, 
        startAfter, 
        timestampPtr, 
        value, 
...
static void Handle_query_ReadBufferSampleJson
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = query_ReadBufferSampleJson ( 
        obsPath, 
        startAfter, 
        timestampPtr, 
        value, 
...
static void Handle_query_GetMin
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetMax
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetMean
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetStdDev
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetDataType
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    io_DataType_t dataTypeBuffer = (io_DataType_t) 0;
    io_DataType_t *dataTypePtr = &dataTypeBuffer;
...
static void Handle_query_GetUnits
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    char unitsBuffer[24] = { 0 };
    char *units = unitsBuffer;
    ...
    if ( (unitsSize > 23) &&
         (unitsSize < UINT32_MAX) )
    {
        LE_DEBUG("Adjusting unitsSize from %" PRIuS " to 23", unitsSize);
        unitsSize = 23;
    }
    if (unitsSize >= UINT32_MAX)
    {
        unitsSize = UINT32_MAX;
    }
    else
...
static void Handle_query_GetTimestamp
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetBoolean
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetNumeric
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetString
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetJson
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_query_GetJsonExample
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    char exampleBuffer[50001] = { 0 };
    char *example = exampleBuffer;
    ...
    if ( (exampleSize > 50000) &&
         (exampleSize < UINT32_MAX) )
    {
        LE_DEBUG("Adjusting exampleSize from %" PRIuS " to 50000", exampleSize);
        exampleSize = 50000;
    }
    if (exampleSize >= UINT32_MAX)
    {
        exampleSize = UINT32_MAX;
    }
    else
...
static void AsyncResponse_query_AddTriggerPushHandler
(
    double timestamp,
    void* contextPtr
)
...
static void Handle_query_AddTriggerPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = query_AddTriggerPushHandler ( 
        path, AsyncResponse_query_AddTriggerPushHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)query_RemoveTriggerPushHandler;
...
static void Handle_query_RemoveTriggerPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    query_TriggerPushHandlerRef_t handlerRef = NULL;
    ...
    _UNLOCK
    handlerRef = (query_TriggerPushHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void AsyncResponse_query_AddBooleanPushHandler
(
    double timestamp,
    bool value,
    void* contextPtr
...
static void Handle_query_AddBooleanPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = query_AddBooleanPushHandler ( 
        path, AsyncResponse_query_AddBooleanPushHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->handlerRef = (le_event_HandlerRef_t)_result;
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)query_RemoveBooleanPushHandler;
...
static void Handle_query_RemoveBooleanPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    query_BooleanPushHandlerRef_t handlerRef = NULL;
    if (!le_pack_UnpackReference( &_msgBufPtr,
                                  &handlerRef ))
    {
        goto error_unpack;
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (query_BooleanPushHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void AsyncResponse_query_AddNumericPushHandler
(
    double timestamp,
    double value,
    void* contextPtr
...
static void Handle_query_AddNumericPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = query_AddNumericPushHandler ( 
        path, AsyncResponse_query_AddNumericPushHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->handlerRef = (le_event_HandlerRef_t)_result;
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)query_RemoveNumericPushHandler;
...
static void Handle_query_RemoveNumericPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    query_NumericPushHandlerRef_t handlerRef = NULL;
    if (!le_pack_UnpackReference( &_msgBufPtr,
                                  &handlerRef ))
    {
        goto error_unpack;
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (query_NumericPushHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void AsyncResponse_query_AddStringPushHandler
(
    double timestamp,
...
static void Handle_query_AddStringPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = query_AddStringPushHandler ( 
        path, AsyncResponse_query_AddStringPushHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->handlerRef = (le_event_HandlerRef_t)_result;
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)query_RemoveStringPushHandler;
...
static void Handle_query_RemoveStringPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    query_StringPushHandlerRef_t handlerRef = NULL;
    if (!le_pack_UnpackReference( &_msgBufPtr,
                                  &handlerRef ))
    {
        goto error_unpack;
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (query_StringPushHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void AsyncResponse_query_AddJsonPushHandler
(
    double timestamp,
    const char* LE_NONNULL value,
    void* contextPtr
...
static void Handle_query_AddJsonPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = query_AddJsonPushHandler ( 
        path, AsyncResponse_query_AddJsonPushHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->handlerRef = (le_event_HandlerRef_t)_result;
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)query_RemoveJsonPushHandler;
...
static void Handle_query_RemoveJsonPushHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    query_JsonPushHandlerRef_t handlerRef = NULL;
    if (!le_pack_UnpackReference( &_msgBufPtr,
                                  &handlerRef ))
    {
        goto error_unpack;
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (query_JsonPushHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_query_ReadBufferJson :
            Handle_query_ReadBufferJson(msgRef);
            break;
        case _MSGID_query_ReadBufferSampleTimestamp :
            Handle_query_ReadBufferSampleTimestamp(msgRef);
            break;
        case _MSGID_query_ReadBufferSampleBoolean :
            Handle_query_ReadBufferSampleBoolean(msgRef);
            break;
        case _MSGID_query_ReadBufferSampleNumeric :
            Handle_query_ReadBufferSampleNumeric(msgRef);
            break;
        case _MSGID_query_ReadBufferSampleString :
            Handle_query_ReadBufferSampleString(msgRef);
            break;
        case _MSGID_query_ReadBufferSampleJson :
            Handle_query_ReadBufferSampleJson(msgRef);
            break;
        case _MSGID_query_GetMin :
            Handle_query_GetMin(msgRef);
            break;
        case _MSGID_query_GetMax :
            Handle_query_GetMax(msgRef);
            break;
        case _MSGID_query_GetMean :
            Handle_query_GetMean(msgRef);
            break;
        case _MSGID_query_GetStdDev :
            Handle_query_GetStdDev(msgRef);
            break;
        case _MSGID_query_GetDataType :
            Handle_query_GetDataType(msgRef);
            break;
        case _MSGID_query_GetUnits :
            Handle_query_GetUnits(msgRef);
            break;
        case _MSGID_query_GetTimestamp :
            Handle_query_GetTimestamp(msgRef);
            break;
        case _MSGID_query_GetBoolean :
            Handle_query_GetBoolean(msgRef);
            break;
        case _MSGID_query_GetNumeric :
            Handle_query_GetNumeric(msgRef);
            break;
        case _MSGID_query_GetString :
            Handle_query_GetString(msgRef);
            break;
        case _MSGID_query_GetJson :
            Handle_query_GetJson(msgRef);
            break;
        case _MSGID_query_GetJsonExample :
            Handle_query_GetJsonExample(msgRef);
            break;
        case _MSGID_query_AddTriggerPushHandler :
            Handle_query_AddTriggerPushHandler(msgRef);
            break;
        case _MSGID_query_RemoveTriggerPushHandler :
            Handle_query_RemoveTriggerPushHandler(msgRef);
            break;
        case _MSGID_query_AddBooleanPushHandler :
            Handle_query_AddBooleanPushHandler(msgRef);
            break;
        case _MSGID_query_RemoveBooleanPushHandler :
            Handle_query_RemoveBooleanPushHandler(msgRef);
            break;
        case _MSGID_query_AddNumericPushHandler :
            Handle_query_AddNumericPushHandler(msgRef);
            break;
        case _MSGID_query_RemoveNumericPushHandler :
            Handle_query_RemoveNumericPushHandler(msgRef);
            break;
        case _MSGID_query_AddStringPushHandler :
            Handle_query_AddStringPushHandler(msgRef);
            break;
        case _MSGID_query_RemoveStringPushHandler :
            Handle_query_RemoveStringPushHandler(msgRef);
            break;
        case _MSGID_query_AddJsonPushHandler :
            Handle_query_AddJsonPushHandler(msgRef);
            break;
        case _MSGID_query_RemoveJsonPushHandler :
            Handle_query_RemoveJsonPushHandler(msgRef);
            break;
