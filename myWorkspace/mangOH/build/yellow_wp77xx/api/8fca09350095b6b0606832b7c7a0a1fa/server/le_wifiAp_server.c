 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_wifiAp_ServerData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_wifiAp_ServerHandlers,
    LE_MEM_BLOCKS(le_wifiAp_ServerCmd, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(le_wifiAp_ServerData,
                                            HIGH_SERVER_DATA_COUNT,
                                            sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    _HandlerRefMap = le_ref_InitStaticMap(le_wifiAp_ServerHandlers,
                        LE_MEM_BLOCKS(le_wifiAp_ServerData, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    LE_ASSERT(le_wifiAp_PackEvent( &_msgBufPtr,
                                                  event ));
...
)
{
    ...
    // Unpack the input parameters from the message
    le_wifiAp_NewEventHandlerRef_t handlerRef = NULL;
...
)
{
    ...
    uint8_t* _msgBufStartPtr = _msgBufPtr;
    // Declare temporaries for input parameters
    le_wifiAp_SecurityProtocol_t securityProtocol = (le_wifiAp_SecurityProtocol_t) 0;
    ...
    // Unpack the input parameters from the message
    if (!le_wifiAp_UnpackSecurityProtocol( &_msgBufPtr,
                                               &securityProtocol ))
    {
        goto error_unpack;
    }
...
static void Handle_le_wifiAp_SetIeeeStandard
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    uint8_t* _msgBufStartPtr = _msgBufPtr;
    // Declare temporaries for input parameters
    le_wifiAp_IeeeStdBitMask_t stdMask = (le_wifiAp_IeeeStdBitMask_t) 0;
    ...
    // Unpack the input parameters from the message
    if (!le_wifiAp_UnpackIeeeStdBitMask( &_msgBufPtr,
                                               &stdMask ))
    {
        goto error_unpack;
    }
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiAp_SetIeeeStandard ( 
        stdMask );
...
static void Handle_le_wifiAp_GetIeeeStandard
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    le_wifiAp_IeeeStdBitMask_t stdMaskPtrBuffer = (le_wifiAp_IeeeStdBitMask_t) 0;
    le_wifiAp_IeeeStdBitMask_t *stdMaskPtrPtr = &stdMaskPtrBuffer;
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiAp_GetIeeeStandard ( 
        stdMaskPtrPtr );
...
static void Handle_le_wifiAp_SetCountryCode
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiAp_SetCountryCode ( 
        countryCode );
...
)
{
    ...
    // Unpack the input parameters from the message
    if (!le_pack_UnpackInt8( &_msgBufPtr,
                                               &maxNumberOfClient ))
    {
        goto error_unpack;
    }
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_wifiAp_AddNewEventHandler :
            Handle_le_wifiAp_AddNewEventHandler(msgRef);
            break;
        case _MSGID_le_wifiAp_RemoveNewEventHandler :
            Handle_le_wifiAp_RemoveNewEventHandler(msgRef);
            break;
        case _MSGID_le_wifiAp_Start :
            Handle_le_wifiAp_Start(msgRef);
            break;
        case _MSGID_le_wifiAp_Stop :
            Handle_le_wifiAp_Stop(msgRef);
            break;
        case _MSGID_le_wifiAp_SetSsid :
            Handle_le_wifiAp_SetSsid(msgRef);
            break;
        case _MSGID_le_wifiAp_SetSecurityProtocol :
            Handle_le_wifiAp_SetSecurityProtocol(msgRef);
            break;
        case _MSGID_le_wifiAp_SetPassPhrase :
            Handle_le_wifiAp_SetPassPhrase(msgRef);
            break;
        case _MSGID_le_wifiAp_SetPreSharedKey :
            Handle_le_wifiAp_SetPreSharedKey(msgRef);
            break;
        case _MSGID_le_wifiAp_SetDiscoverable :
            Handle_le_wifiAp_SetDiscoverable(msgRef);
            break;
        case _MSGID_le_wifiAp_SetIeeeStandard :
            Handle_le_wifiAp_SetIeeeStandard(msgRef);
            break;
        case _MSGID_le_wifiAp_GetIeeeStandard :
            Handle_le_wifiAp_GetIeeeStandard(msgRef);
            break;
        case _MSGID_le_wifiAp_SetChannel :
            Handle_le_wifiAp_SetChannel(msgRef);
            break;
        case _MSGID_le_wifiAp_SetCountryCode :
            Handle_le_wifiAp_SetCountryCode(msgRef);
            break;
        case _MSGID_le_wifiAp_SetMaxNumberOfClients :
            Handle_le_wifiAp_SetMaxNumberOfClients(msgRef);
            break;
        case _MSGID_le_wifiAp_SetIpRange :
            Handle_le_wifiAp_SetIpRange(msgRef);
            break;
