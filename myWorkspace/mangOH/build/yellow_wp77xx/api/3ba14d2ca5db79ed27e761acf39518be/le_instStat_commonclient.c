 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_instStat_ClientData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_instStat_ClientHandlers,
    LE_MEM_BLOCKS(le_instStat_ClientData, HIGH_CLIENT_DATA_COUNT));
...
)
{
    ...
    _LOCK;
    {
        if (!_ClientDataPool)
        {
            ...
            _ClientDataPool = le_mem_InitStaticPool(le_instStat_ClientData,
                                                    HIGH_CLIENT_DATA_COUNT,
                                                    sizeof(_ClientData_t));
        }
        ...
        if (!_HandlerRefMap)
        {
            ...
            _HandlerRefMap = le_ref_InitStaticMap(le_instStat_ClientHandlers,
                                                  LE_MEM_BLOCKS(le_instStat_ClientData,
                                                                HIGH_CLIENT_DATA_COUNT));
        }
...
static void _Handle_ifgen_le_instStat_AddAppInstallEventHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    le_instStat_AppInstallHandlerFunc_t _handlerRef_ifgen_le_instStat_AddAppInstallEventHandler =
        (le_instStat_AppInstallHandlerFunc_t)_clientDataPtr->handlerPtr;
    ...
    if ( _handlerRef_ifgen_le_instStat_AddAppInstallEventHandler != NULL )
    {
        _handlerRef_ifgen_le_instStat_AddAppInstallEventHandler(appName, contextPtr );
    }
    else
    {
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_instStat_AppInstallEventHandlerRef_t)
...
// This function parses the message buffer received from the server, and then calls the user
// registered handler, which is stored in a client data object.
static void _Handle_ifgen_le_instStat_AddAppUninstallEventHandler
(
    void* _reportPtr,
    void* _dataPtr
)
{
    ...
    // Pull out additional data from the client data pointer
    le_instStat_AppUninstallHandlerFunc_t _handlerRef_ifgen_le_instStat_AddAppUninstallEventHandler =
        (le_instStat_AppUninstallHandlerFunc_t)_clientDataPtr->handlerPtr;
    void* contextPtr = _clientDataPtr->contextPtr;
    ...
    // Call the registered handler
    if ( _handlerRef_ifgen_le_instStat_AddAppUninstallEventHandler != NULL )
    {
        _handlerRef_ifgen_le_instStat_AddAppUninstallEventHandler(appName, contextPtr );
    }
    else
    {
        LE_FATAL("Error in client data: no registered handler");
...
)
{
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (le_instStat_AppUninstallEventHandlerRef_t)
         clientDataPtr->handlerRef;
    le_mem_Release(clientDataPtr);
    LE_ASSERT(le_pack_PackReference( &_msgBufPtr,
                                     handlerRef ));
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_instStat_AddAppInstallEventHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_ifgen_le_instStat_AddAppInstallEventHandler, msgRef, clientDataPtr);
            break;
        case _MSGID_le_instStat_AddAppUninstallEventHandler :
            le_event_QueueFunctionToThread(callersThreadRef, _Handle_ifgen_le_instStat_AddAppUninstallEventHandler, msgRef, clientDataPtr);
            break;
