...
#include "le_kernelModule_service.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_kernelModule_ClientThreadData,
...
)
{
    ...
    le_result_t result = ifgen_le_kernelModule_OpenSession(sessionRef, isBlocking);
    if (result != LE_OK)
    {
...
{
    if (ifgen_le_kernelModule_HasLocalBinding())
    {
        return NULL;
    }
    else
...
static void InitCommonData(void)
{
    ...
    _ClientThreadDataPool = le_mem_InitStaticPool(le_kernelModule_ClientThreadData,
                                                  LE_CDATA_COMPONENT_COUNT,
                                                  sizeof(_ClientThreadData_t));
...
{
    return ifgen_le_kernelModule_Load(
...
{
    return ifgen_le_kernelModule_Unload(
        GetCurrentSessionRef(),
        moduleName
    );
}
