...
)
{
    ...
    uint64_t millisecondsPastGpsEpochBuffer = 0;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_rtc_GetUserTime :
            Handle_le_rtc_GetUserTime(msgRef);
            break;
        case _MSGID_le_rtc_SetUserTime :
            Handle_le_rtc_SetUserTime(msgRef);
            break;
