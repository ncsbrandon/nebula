...
)
{
    ...
    uint8_t* _msgBufStartPtr = _msgBufPtr;
    // Declare temporaries for input parameters
    le_posCtrl_ActivationRef_t ref = NULL;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_posCtrl_Request :
            Handle_le_posCtrl_Request(msgRef);
            break;
        case _MSGID_le_posCtrl_Release :
            Handle_le_posCtrl_Release(msgRef);
            break;
