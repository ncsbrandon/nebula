...
static void Handle_le_net_ChangeRoute
(
...
static void Handle_le_net_SetDefaultGW
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_net_GetDefaultGW
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    le_net_DefaultGatewayAddresses_t addrBuffer = {"", ""};
    le_net_DefaultGatewayAddresses_t *addrPtr = &addrBuffer;
    ...
    if (addrPtr)
    {
        LE_ASSERT(le_net_PackDefaultGatewayAddresses( &_msgBufPtr,
                                                      addrPtr ));
    }
...
static void Handle_le_net_BackupDefaultGW
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_net_RestoreDefaultGW
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_net_RestoreDefaultGW (  );
...
static void Handle_le_net_SetDNS
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_net_GetDNS
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    le_net_DnsServerAddresses_t addrBuffer = {"", "", "", ""};
    le_net_DnsServerAddresses_t *addrPtr = &addrBuffer;
    ...
    if (addrPtr)
    {
        LE_ASSERT(le_net_PackDnsServerAddresses( &_msgBufPtr,
                                                      addrPtr ));
    }
...
static void Handle_le_net_RestoreDNS
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_net_ChangeRoute :
            Handle_le_net_ChangeRoute(msgRef);
            break;
        case _MSGID_le_net_SetDefaultGW :
            Handle_le_net_SetDefaultGW(msgRef);
            break;
        case _MSGID_le_net_GetDefaultGW :
            Handle_le_net_GetDefaultGW(msgRef);
            break;
        case _MSGID_le_net_BackupDefaultGW :
            Handle_le_net_BackupDefaultGW(msgRef);
            break;
        case _MSGID_le_net_RestoreDefaultGW :
            Handle_le_net_RestoreDefaultGW(msgRef);
            break;
        case _MSGID_le_net_SetDNS :
            Handle_le_net_SetDNS(msgRef);
            break;
        case _MSGID_le_net_GetDNS :
            Handle_le_net_GetDNS(msgRef);
            break;
        case _MSGID_le_net_RestoreDNS :
            Handle_le_net_RestoreDNS(msgRef);
            break;
