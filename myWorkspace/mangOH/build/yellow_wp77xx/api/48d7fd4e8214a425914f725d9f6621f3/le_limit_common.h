 ...
 * ====================== WARNING ======================
 */
#ifndef LE_LIMIT_COMMON_H_INCLUDE_GUARD
#define LE_LIMIT_COMMON_H_INCLUDE_GUARD


#include "legato.h"

#define IFGEN_LE_LIMIT_PROTOCOL_ID "bef7579f31c05e49a42d4f28bc2857da"
#define IFGEN_LE_LIMIT_MSG_SIZE 9
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED bool ifgen_le_limit_HasLocalBinding
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED void ifgen_le_limit_InitCommonData
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_SHARED le_result_t ifgen_le_limit_OpenSession
(
    le_msg_SessionRef_t _ifgen_sessionRef,
    bool isBlocking
);

#endif // LE_LIMIT_COMMON_H_INCLUDE_GUARD
