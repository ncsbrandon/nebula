 ...
 *
 * - le_appCtrl_SetDebug() can be used to set or clear the "debug" flag for a given process in the
 *   app.  Setting the "debug" flag will result in the process being started in the stopped state.
 *   A debugger can then be attached to the process.
 *
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_FULL_API void le_appCtrl_SetServerDisconnectHandler
(
