 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_wifiClient_ServerData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_wifiClient_ServerHandlers,
    LE_MEM_BLOCKS(le_wifiClient_ServerCmd, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(le_wifiClient_ServerData,
                                            HIGH_SERVER_DATA_COUNT,
                                            sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    _HandlerRefMap = le_ref_InitStaticMap(le_wifiClient_ServerHandlers,
                        LE_MEM_BLOCKS(le_wifiClient_ServerData, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    LE_ASSERT(le_wifiClient_PackEvent( &_msgBufPtr,
                                                  event ));
...
)
{
    ...
    // Unpack the input parameters from the message
    le_wifiClient_NewEventHandlerRef_t handlerRef = NULL;
...
static void AsyncResponse_le_wifiClient_AddConnectionEventHandler
(
...
)
{
    ...
    LE_ASSERT(le_wifiClient_PackEventInd( &_msgBufPtr,
                                                  wifiEventIndPtr ));
...
static void Handle_le_wifiClient_AddConnectionEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = le_wifiClient_AddConnectionEventHandler ( AsyncResponse_le_wifiClient_AddConnectionEventHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->handlerRef = (le_event_HandlerRef_t)_result;
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_wifiClient_RemoveConnectionEventHandler;
...
static void Handle_le_wifiClient_RemoveConnectionEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_wifiClient_ConnectionEventHandlerRef_t handlerRef = NULL;
    if (!le_pack_UnpackReference( &_msgBufPtr,
                                  &handlerRef ))
    {
        goto error_unpack;
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (le_wifiClient_ConnectionEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
)
{
    ...
    // Pack the result first
    LE_ASSERT(le_pack_PackInt16( &_msgBufPtr, _result ));
...
)
{
    ...
    {
        LE_DEBUG("Adjusting bssidSize from %" PRIuS " to 18", bssidSize);
        bssidSize = 18;
    }
...
)
{
    ...
    if ( (ssidSize > 33) )
    {
        LE_DEBUG("Adjusting ssidSize from %" PRIuS " to 33", ssidSize);
        ssidSize = 33;
    }
...
static void Handle_le_wifiClient_GetCurrentConnection
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    le_wifiClient_AccessPointRef_t apRefBuffer = NULL;
    le_wifiClient_AccessPointRef_t *apRefPtr = &apRefBuffer;
...
)
{
    ...
    // Declare temporaries for input parameters
    le_wifiClient_AccessPointRef_t accessPointRef = NULL;
    le_wifiClient_SecurityProtocol_t securityProtocol = (le_wifiClient_SecurityProtocol_t) 0;
    ...
    if (!le_wifiClient_UnpackSecurityProtocol( &_msgBufPtr,
                                               &securityProtocol ))
    {
        goto error_unpack;
    }
...
static void Handle_le_wifiClient_LoadSsid
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_LoadSsid ( 
        ssidPtr, 
        ssidSize, 
        apRefPtr );
...
static void Handle_le_wifiClient_ConfigureWep
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_ConfigureWep ( 
        ssidPtr, 
        ssidSize, 
        wepKeyPtr, 
        wepKeySize );
...
static void Handle_le_wifiClient_ConfigurePsk
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    uint8_t
        ssidPtr[33]
            = { 0 };
    bool ssidResult;
    le_wifiClient_SecurityProtocol_t protocol = (le_wifiClient_SecurityProtocol_t) 0;
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_ConfigurePsk ( 
        ssidPtr, 
        ssidSize, 
        protocol, 
        passPhrasePtr, 
...
static void Handle_le_wifiClient_ConfigureEap
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_ConfigureEap ( 
        ssidPtr, 
        ssidSize, 
        protocol, 
        usernamePtr, 
...
static void Handle_le_wifiClient_RemoveSsidSecurityConfigs
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_wifiClient_RemoveSsidSecurityConfigs ( 
        ssidPtr, 
        ssidSize );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_wifiClient_AddNewEventHandler :
            Handle_le_wifiClient_AddNewEventHandler(msgRef);
            break;
        case _MSGID_le_wifiClient_RemoveNewEventHandler :
            Handle_le_wifiClient_RemoveNewEventHandler(msgRef);
            break;
        case _MSGID_le_wifiClient_AddConnectionEventHandler :
            Handle_le_wifiClient_AddConnectionEventHandler(msgRef);
            break;
        case _MSGID_le_wifiClient_RemoveConnectionEventHandler :
            Handle_le_wifiClient_RemoveConnectionEventHandler(msgRef);
            break;
        case _MSGID_le_wifiClient_Start :
            Handle_le_wifiClient_Start(msgRef);
            break;
        case _MSGID_le_wifiClient_Stop :
            Handle_le_wifiClient_Stop(msgRef);
            break;
        case _MSGID_le_wifiClient_Scan :
            Handle_le_wifiClient_Scan(msgRef);
            break;
        case _MSGID_le_wifiClient_GetFirstAccessPoint :
            Handle_le_wifiClient_GetFirstAccessPoint(msgRef);
            break;
        case _MSGID_le_wifiClient_GetNextAccessPoint :
            Handle_le_wifiClient_GetNextAccessPoint(msgRef);
            break;
        case _MSGID_le_wifiClient_GetSignalStrength :
            Handle_le_wifiClient_GetSignalStrength(msgRef);
            break;
        case _MSGID_le_wifiClient_GetBssid :
            Handle_le_wifiClient_GetBssid(msgRef);
            break;
        case _MSGID_le_wifiClient_GetSsid :
            Handle_le_wifiClient_GetSsid(msgRef);
            break;
        case _MSGID_le_wifiClient_GetCurrentConnection :
            Handle_le_wifiClient_GetCurrentConnection(msgRef);
            break;
        case _MSGID_le_wifiClient_SetPassphrase :
            Handle_le_wifiClient_SetPassphrase(msgRef);
            break;
        case _MSGID_le_wifiClient_SetPreSharedKey :
            Handle_le_wifiClient_SetPreSharedKey(msgRef);
            break;
        case _MSGID_le_wifiClient_SetSecurityProtocol :
            Handle_le_wifiClient_SetSecurityProtocol(msgRef);
            break;
        case _MSGID_le_wifiClient_SetUserCredentials :
            Handle_le_wifiClient_SetUserCredentials(msgRef);
            break;
        case _MSGID_le_wifiClient_SetWepKey :
            Handle_le_wifiClient_SetWepKey(msgRef);
            break;
        case _MSGID_le_wifiClient_SetHiddenNetworkAttribute :
            Handle_le_wifiClient_SetHiddenNetworkAttribute(msgRef);
            break;
        case _MSGID_le_wifiClient_Create :
            Handle_le_wifiClient_Create(msgRef);
            break;
        case _MSGID_le_wifiClient_Delete :
            Handle_le_wifiClient_Delete(msgRef);
            break;
        case _MSGID_le_wifiClient_Connect :
            Handle_le_wifiClient_Connect(msgRef);
            break;
        case _MSGID_le_wifiClient_Disconnect :
            Handle_le_wifiClient_Disconnect(msgRef);
            break;
        case _MSGID_le_wifiClient_LoadSsid :
            Handle_le_wifiClient_LoadSsid(msgRef);
            break;
        case _MSGID_le_wifiClient_ConfigureWep :
            Handle_le_wifiClient_ConfigureWep(msgRef);
            break;
        case _MSGID_le_wifiClient_ConfigurePsk :
            Handle_le_wifiClient_ConfigurePsk(msgRef);
            break;
        case _MSGID_le_wifiClient_ConfigureEap :
            Handle_le_wifiClient_ConfigureEap(msgRef);
            break;
        case _MSGID_le_wifiClient_RemoveSsidSecurityConfigs :
            Handle_le_wifiClient_RemoveSsidSecurityConfigs(msgRef);
            break;
