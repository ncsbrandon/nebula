 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_appInfo_ClientThreadData,
...
)
{
    ...
    le_result_t result = ifgen_le_appInfo_OpenSession(sessionRef, isBlocking);
    if (result != LE_OK)
    {
...
{
    if (ifgen_le_appInfo_HasLocalBinding())
    {
        return NULL;
    }
    else
...
static void InitCommonData(void)
{
    ...
    _ClientThreadDataPool = le_mem_InitStaticPool(le_appInfo_ClientThreadData,
                                                  LE_CDATA_COMPONENT_COUNT,
                                                  sizeof(_ClientThreadData_t));
...
{
    return ifgen_le_appInfo_GetState(
...
{
    return ifgen_le_appInfo_GetProcState(
        GetCurrentSessionRef(),
        appName,
        procName
    );
...
{
    return ifgen_le_appInfo_GetName(
        GetCurrentSessionRef(),
        pid,
        appName,
        appNameSize
...
{
    return ifgen_le_appInfo_GetHash(
        GetCurrentSessionRef(),
        appName,
        hashStr,
        hashStrSize
