...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_mdmCfg_StoreCurrentConfiguration :
            Handle_le_mdmCfg_StoreCurrentConfiguration(msgRef);
            break;
        case _MSGID_le_mdmCfg_RestoreSavedConfiguration :
            Handle_le_mdmCfg_RestoreSavedConfiguration(msgRef);
            break;
