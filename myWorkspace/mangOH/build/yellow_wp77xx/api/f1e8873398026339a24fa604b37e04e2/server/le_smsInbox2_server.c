...
#include "le_smsInbox2_service.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_smsInbox2_ServerData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_smsInbox2_ServerHandlers,
    LE_MEM_BLOCKS(le_smsInbox2_ServerCmd, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(le_smsInbox2_ServerData,
                                            HIGH_SERVER_DATA_COUNT,
                                            sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    _HandlerRefMap = le_ref_InitStaticMap(le_smsInbox2_ServerHandlers,
                        LE_MEM_BLOCKS(le_smsInbox2_ServerData, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    uint8_t* _msgBufStartPtr = _msgBufPtr;
    // Declare temporaries for input parameters
    le_smsInbox2_SessionRef_t sessionRef = NULL;
...
)
{
    ...
    // Unpack the input parameters from the message
    le_smsInbox2_RxMessageHandlerRef_t handlerRef = NULL;
    if (!le_pack_UnpackReference( &_msgBufPtr,
                                  &handlerRef ))
    {
        goto error_unpack;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_smsInbox1_Open :
            Handle_le_smsInbox2_Open(msgRef);
            break;
        case _MSGID_le_smsInbox1_Close :
            Handle_le_smsInbox2_Close(msgRef);
            break;
        case _MSGID_le_smsInbox1_AddRxMessageHandler :
            Handle_le_smsInbox2_AddRxMessageHandler(msgRef);
            break;
        case _MSGID_le_smsInbox1_RemoveRxMessageHandler :
            Handle_le_smsInbox2_RemoveRxMessageHandler(msgRef);
            break;
        case _MSGID_le_smsInbox1_DeleteMsg :
            Handle_le_smsInbox2_DeleteMsg(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetImsi :
            Handle_le_smsInbox2_GetImsi(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetFormat :
            Handle_le_smsInbox2_GetFormat(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetSenderTel :
            Handle_le_smsInbox2_GetSenderTel(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetTimeStamp :
            Handle_le_smsInbox2_GetTimeStamp(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetMsgLen :
            Handle_le_smsInbox2_GetMsgLen(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetText :
            Handle_le_smsInbox2_GetText(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetBinary :
            Handle_le_smsInbox2_GetBinary(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetPdu :
            Handle_le_smsInbox2_GetPdu(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetFirst :
            Handle_le_smsInbox2_GetFirst(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetNext :
            Handle_le_smsInbox2_GetNext(msgRef);
            break;
        case _MSGID_le_smsInbox1_IsUnread :
            Handle_le_smsInbox2_IsUnread(msgRef);
            break;
        case _MSGID_le_smsInbox1_MarkRead :
            Handle_le_smsInbox2_MarkRead(msgRef);
            break;
        case _MSGID_le_smsInbox1_MarkUnread :
            Handle_le_smsInbox2_MarkUnread(msgRef);
            break;
        case _MSGID_le_smsInbox1_SetMaxMessages :
            Handle_le_smsInbox2_SetMaxMessages(msgRef);
            break;
        case _MSGID_le_smsInbox1_GetMaxMessages :
            Handle_le_smsInbox2_GetMaxMessages(msgRef);
            break;
