...
#include "le_coap_server.h"
#include "le_coap_messages.h"
#include "le_coap_service.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_MEM_DEFINE_STATIC_POOL(le_coap_ServerData,
 ...
 */
//--------------------------------------------------------------------------------------------------
LE_REF_DEFINE_STATIC_MAP(le_coap_ServerHandlers,
    LE_MEM_BLOCKS(le_coap_ServerCmd, HIGH_SERVER_DATA_COUNT));
...
)
{
    ...
    _ServerDataPool = le_mem_InitStaticPool(le_coap_ServerData,
                                            HIGH_SERVER_DATA_COUNT,
                                            sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    _HandlerRefMap = le_ref_InitStaticMap(le_coap_ServerHandlers,
                        LE_MEM_BLOCKS(le_coap_ServerData, HIGH_SERVER_DATA_COUNT));
...
static void Handle_le_coap_SendResponse
(
...
)
{
    ...
    le_coap_Code_t responseCode = (le_coap_Code_t) 0;
    le_coap_StreamStatus_t streamStatus = (le_coap_StreamStatus_t) 0;
    ...
    if (!le_coap_UnpackCode( &_msgBufPtr,
                                               &responseCode ))
    {
        goto error_unpack;
    }
    if (!le_coap_UnpackStreamStatus( &_msgBufPtr,
                                               &streamStatus ))
    {
        goto error_unpack;
    }
...
static void AsyncResponse_le_coap_AddMessageEventHandler
(
    le_coap_Code_t code,
...
)
{
    ...
    _msgPtr->id = _MSGID_le_coap_AddMessageEventHandler;
    ...
    LE_ASSERT(le_coap_PackCode( &_msgBufPtr,
                                                  code ));
    LE_ASSERT(le_coap_PackStreamStatus( &_msgBufPtr,
                                                  stream ));
    ...
    bool tokenResult;
            LE_PACK_PACKARRAY( &_msgBufPtr,
                       ...
                       9, le_pack_PackUint8,
                       &tokenResult );
    LE_ASSERT(tokenResult);
    bool payloadResult;
            LE_PACK_PACKARRAY( &_msgBufPtr,
                       payloadPtr, payloadSize,
                       1025, le_pack_PackUint8,
                       &payloadResult );
    LE_ASSERT(payloadResult);
    LE_ASSERT(le_pack_PackUint16( &_msgBufPtr,
                                                  blockSize ));
...
static void Handle_le_coap_AddMessageEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_coap_MessageEventHandlerRef_t _result;
    _result  = le_coap_AddMessageEventHandler ( AsyncResponse_le_coap_AddMessageEventHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_coap_RemoveMessageEventHandler;
...
static void Handle_le_coap_RemoveMessageEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_coap_MessageEventHandlerRef_t handlerRef = NULL;
    ...
    _UNLOCK
    handlerRef = (le_coap_MessageEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Call the function
    le_coap_RemoveMessageEventHandler ( 
        handlerRef );
...
static void AsyncResponse_le_coap_AddPushEventHandler
(
...
)
{
    ...
    _msgRef = le_msg_CreateMsg(serverDataPtr->clientSessionRef);
    _msgPtr = le_msg_GetPayloadPtr(_msgRef);
    _msgPtr->id = _MSGID_le_coap_AddPushEventHandler;
    _msgBufPtr = _msgPtr->buffer;
    ...
    LE_ASSERT(le_coap_PackPushStatus( &_msgBufPtr,
                                                  status ));
    bool tokenResult;
            LE_PACK_PACKARRAY( &_msgBufPtr,
                       tokenPtr, tokenSize,
...
static void Handle_le_coap_AddPushEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_coap_PushEventHandlerRef_t _result;
    _result  = le_coap_AddPushEventHandler ( AsyncResponse_le_coap_AddPushEventHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->handlerRef = (le_event_HandlerRef_t)_result;
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_coap_RemovePushEventHandler;
...
static void Handle_le_coap_RemovePushEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_coap_PushEventHandlerRef_t handlerRef = NULL;
    if (!le_pack_UnpackReference( &_msgBufPtr,
                                  &handlerRef ))
    {
        goto error_unpack;
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (le_coap_PushEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Call the function
    le_coap_RemovePushEventHandler ( 
        handlerRef );
...
static void Handle_le_coap_Push
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_coap_SendResponse :
            Handle_le_coap_SendResponse(msgRef);
            break;
        case _MSGID_le_coap_AddMessageEventHandler :
            Handle_le_coap_AddMessageEventHandler(msgRef);
            break;
        case _MSGID_le_coap_RemoveMessageEventHandler :
            Handle_le_coap_RemoveMessageEventHandler(msgRef);
            break;
        case _MSGID_le_coap_AddPushEventHandler :
            Handle_le_coap_AddPushEventHandler(msgRef);
            break;
        case _MSGID_le_coap_RemovePushEventHandler :
            Handle_le_coap_RemovePushEventHandler(msgRef);
            break;
        case _MSGID_le_coap_Push :
            Handle_le_coap_Push(msgRef);
            break;
